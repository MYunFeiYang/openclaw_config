# AGENTS.md - Frontend workspace（agent: `frontend`）

**Agent id：** `frontend`。官方规则见 [Multi-Agent](https://docs.openclaw.ai/concepts/multi-agent) · [Agent Workspace](https://docs.openclaw.ai/concepts/agent-workspace) · [Skills](https://docs.openclaw.ai/tools/skills)（不展开）。多 agent 约定与总览见 `~/.openclaw/workspace/AGENTS.md`。
...
1. Use **`openclaw.json`** **identity** + **`SOUL.md`**「本代理职责」— answer must reflect **only** this agent id (`frontend` here).
...
见 [Skills](https://docs.openclaw.ai/tools/skills)。对用户：工具在 tool schema；技能名以系统提示为准，勿编造。
