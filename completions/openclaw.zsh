...
_openclaw_config() {
  ...
  _arguments -C \
    ...
    "1: :_values 'command' 'get[Get a config value by dot path]' 'set[Set a config value by dot path]' 'unset[Remove a config value by dot path]' 'file[Print the active config file path]'" \
    "*::arg:->args"
