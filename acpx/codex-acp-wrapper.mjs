...
const installedBinPath = "/Users/thinkway/.openclaw/npm/node_modules/@zed-industries/codex-acp/bin/codex-acp.js";
let defaultCommand;
let defaultArgs;
if (installedBinPath) {
  ...
  defaultCommand = process.execPath;
  defaultArgs = [npmCliPath, "exec", "--yes", "--package", "@zed-industries/codex-acp@0.14.0", "--", "codex-acp"];
} else {
  defaultCommand = process.platform === "win32" ? "npx.cmd" : "npx";
  defaultArgs = ["--yes", "--package", "@zed-industries/codex-acp@0.14.0", "--", "codex-acp"];
}
const command =
