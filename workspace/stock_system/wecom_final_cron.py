...
from wecom_predict_then_summarize import WecomPredictThenSummarize
...
def main():
    ...
    if len(sys.argv) < 2:
        print("错误: 需要指定分析类型")
        print("用法: python3 wecom_final_cron.py [morning|afternoon|evening|weekly]")
        return 1
