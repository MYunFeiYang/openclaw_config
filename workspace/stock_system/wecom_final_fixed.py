...
class WecomStockAnalysis:
    ...
    def run_analysis(self, analysis_type: str = "evening") -> Dict:
        """运行分析"""
    ...
    def generate_single_prediction(self, stock: Dict, analysis_type: str, seed_str: str) -> Dict:
        """生成单只股票预测"""
    ...
    def analyze_market_overview(self, predictions: List[Dict], buy: List[Dict], sell: List[Dict], hold: List[Dict]) -> Dict:
        """分析市场概况"""
