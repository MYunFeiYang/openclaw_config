#!/usr/bin/env python3
"""
企业微信最终简化版"先预测再总结"定时任务脚本
专为OpenClaw cron系统设计，确保企微格式兼容
"""
...
from wecom_simple_final import WecomSimpleFinal
...
def main():
    ...
    if len(sys.argv) < 2:
        print("错误: 需要指定分析类型")
        print("用法: python3 wecom_final_cron_simple.py [morning|afternoon|evening|weekly]")
        return 1
