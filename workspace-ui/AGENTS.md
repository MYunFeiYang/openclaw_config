# AGENTS.md - UI workspace（agent: `ui`）

**Agent id：** `ui`。官方规则见 [Multi-Agent](https://docs.openclaw.ai/concepts/multi-agent) · [Agent Workspace](https://docs.openclaw.ai/concepts/agent-workspace) · [Skills](https://docs.openclaw.ai/tools/skills)（不展开）。
...
1. Use **`openclaw.json`** **identity** + **`SOUL.md`**「本代理职责」— answer must reflect **only** this agent id (`ui` here).
