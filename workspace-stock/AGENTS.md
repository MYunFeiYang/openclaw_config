# AGENTS.md - Stock workspace（agent: `stock`）

**Agent id：** `stock`。官方规则见 [Multi-Agent](https://docs.openclaw.ai/concepts/multi-agent) · [Agent Workspace](https://docs.openclaw.ai/concepts/agent-workspace) · [Skills](https://docs.openclaw.ai/tools/skills)（不展开）。**本仓库：** `stock_system/`；Cron 路径见本机 `cron`/`SETUP`。
...
1. Use **`openclaw.json`** **identity** + **`SOUL.md`**「本代理职责」— answer must reflect **only** this agent id (`stock` here).
