...
function fireAndForgetHook(task, label, logger = _globalsBmUmhyAe.r) {
  task.catch((err) => {
...
function fireAndForgetBoundedHook(task, label, logger = _globalsBmUmhyAe.r, options = {}) {
...
const getLog = () => (0, _subsystemLmgZvqF.t)("plugins");
/**
