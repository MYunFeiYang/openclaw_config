...
require("./fetch-timeout-BUAEM0Ff.js");
var _channelLifecycleCore5vp7guB = require("./channel-lifecycle.core-5vp7guB-.js");
var _runtimeLoggerBu5yF5Ad = require("./runtime-logger-Bu5yF5Ad.js");
...
async function runStoppablePassiveMonitor(params) {
  await (0, _channelLifecycleCore5vp7guB.i)({
...
function resolveLoggerBackedRuntime(runtime, logger) {
  return runtime ?? (0, _runtimeLoggerBu5yF5Ad.t)({
    logger,
