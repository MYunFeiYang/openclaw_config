...
var _sessionWriteLockBbTL9Bo = require("./session-write-lock-Bb-tL9Bo.js");
...
async function resolveAndPersistSessionFile(params) {
  ...
  if (baseEntry.sessionId !== sessionId || baseEntry.sessionFile !== sessionFile) {
    ...
    await (0, _storeCmwzJ9N.s)(storePath, (store) => {
      store[sessionKey] = {
        ...store[sessionKey],
        ...persistedEntry
      };
...
async function appendSessionTranscriptMessageLocked(params) {
  const lock = await (0, _sessionWriteLockBbTL9Bo.a)({
    sessionFile: params.transcriptPath,
    ...(0, _sessionWriteLockBbTL9Bo.f)(params.config),
    allowReentrant: true
  });
  try {
...
async function resolveSessionTranscriptFile(params) {
  ...
  if (params.sessionStore && params.storePath) {
    const threadIdFromSessionKey = (0, _storeLoadDjaY7SAt.S)(params.sessionKey).threadId;
...
async function appendExactAssistantMessageToSessionTranscript(params) {
  ...
  const store = (0, _storeLoadDjaY7SAt.t)(storePath, { skipCache: true });
