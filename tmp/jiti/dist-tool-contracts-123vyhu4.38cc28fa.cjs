"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = normalizeAgentToolResultMiddlewareRuntimeIds;exports.i = listAgentToolResultMiddlewares;exports.n = normalizePluginToolContractNames;exports.o = normalizeAgentToolResultMiddlewareRuntimes;exports.r = normalizePluginToolNames;exports.t = findUndeclaredPluginToolNames;var _runtimeNSi6iKFR = require("./runtime-nSi6iKFR.js");
...
function listAgentToolResultMiddlewares(runtime) {
  return (0, _runtimeNSi6iKFR.a)()?.agentToolResultMiddlewares?.filter((entry) => entry.runtimes.includes(runtime)).map((entry) => entry.handler) ?? [];
}
//#endregion
