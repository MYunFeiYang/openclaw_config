"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = runMemoryStatus;exports.t = registerMemoryCli;var _linksBszRQhGa = require("./links-BszRQhGa.js");
var _themeB128avno = require("./theme-B128avno.js");
var _helpFormatCmO6sKiH = require("./help-format-CmO6sKiH.js");
require("./memory-core-host-runtime-cli-Dr59lBH7.js");
var _shortTermPromotionBU_sr5Sj = require("./short-term-promotion-BU_sr5Sj.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
//#region extensions/memory-core/src/cli.ts
let memoryCliRuntimePromise = null;
async function loadMemoryCliRuntime() {
  memoryCliRuntimePromise ??= Promise.resolve().then(() => jitiImport("./cli.runtime-DnOWx3sn.js").then((m) => _interopRequireWildcard(m)));
...
function registerMemoryCli(program) {
  ...
  [`openclaw memory promote --limit 10 --min-score ${_shortTermPromotionBU_sr5Sj.t}`, "Review weighted short-term candidates for long-term memory."],
  ...
  )}\n\n${_themeB128avno.r.muted("Docs:")} ${(0, _linksBszRQhGa.t)("/cli/memory", "docs.openclaw.ai/cli/memory")}\n`);
  ...
  memory.command("promote").description("Rank short-term recalls and optionally append top entries to MEMORY.md").option("--agent <id>", "Agent id (default: default agent)").option("--limit <n>", "Max candidates", (value) => Number(value)).option("--min-score <n>", `Minimum weighted score (default: ${_shortTermPromotionBU_sr5Sj.t})`, (value) => Number(value)).option("--min-recall-count <n>", `Minimum recall count (default: 3)`, (value) => Number(value)).option("--min-unique-queries <n>", `Minimum distinct query count (default: 2)`, (value) => Number(value)).option("--apply", "Append selected candidates to MEMORY.md", false).option("--include-promoted", "Include already promoted candidates", false).option("--json", "Print JSON").action(async (opts) => {
