"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = appendAllowedValuesHint;exports.r = summarizeAllowedValues;exports.t = validateJsonSchemaValue;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
var _pluginCachePrimitivesWfwcOrBF = require("./plugin-cache-primitives-WfwcOrBF.js");
var _safeTextBe5ocph = require("./safe-text-Be-5ocph.js");
...
function messageAlreadyIncludesAllowedValues(message) {
  const lower = (0, _stringCoerceBje8XVt.a)(message);
...
const _require = (0, _nodeModule.createRequire)("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/schema-validator-DSVrkbYC.js");
...
const schemaCache = new _pluginCachePrimitivesWfwcOrBF.t(512);
...
function formatAjvErrors(errors) {
  ...
  return errors.map((error) => {
    ...
    return {
      path,
      message,
      text: `${(0, _safeTextBe5ocph.t)(path)}: ${(0, _safeTextBe5ocph.t)(message)}`,
