...
var _envMqKSAeAo = require("./env-mqKSAeAo.js");
...
var _dotenvM4k7IwY = require("./dotenv-m4k7IwY4.js");
var _installedPluginIndexRecordsBEXTtiS = require("./installed-plugin-index-records-BEXTtiS3.js");
...
var _modelRefSharedDTXcmZXB = require("./model-ref-shared-DTXcmZXB.js");
var _mergePatchB1KO8sev = require("./merge-patch-B1KO8sev.js");
var _defaultsCWlUbhpa = require("./defaults-CWlUbhpa.js");
var _thinkingCvQif4jm = require("./thinking-CvQif4jm.js");
var _talkEgZSwsfJ = require("./talk-EgZSwsfJ.js");
...
var _providerEnvVarsCDIyh39z = require("./provider-env-vars-CDIyh39z.js");
var _bundledCompatC5xrsnA = require("./bundled-compat-C5xrsn-a.js");
...
var _zodSchemaB8qk5q8o = require("./zod-schema-B8qk5q8o.js");
...
function shouldEnableShellEnvFallback(env) {
  return (0, _envMqKSAeAo.t)(env.OPENCLAW_LOAD_SHELL_ENV);
}
function shouldDeferShellEnvFallback(env) {
  return (0, _envMqKSAeAo.t)(env.OPENCLAW_DEFER_SHELL_ENV_FALLBACK);
}
...
function stampConfigWriteMetadata(cfg, now = (/* @__PURE__ */new Date()).toISOString(), version = _versionB2G3zXnp.n) {
  return {
    ...cfg,
    meta: {
      ...cfg.meta,
...
function normalizeModelProviderCatalogRefsForWrite(config) {
  ...
  for (const [provider, providerConfig] of Object.entries(providers)) {
    ...
    const models = providerConfig.models.map((model) => {
      ...
      const id = (0, _modelRefSharedDTXcmZXB.r)(provider, trimmed);
...
function normalizeProviderConfigForConfigDefaults(params) {
  const normalized = (0, _thinkingCvQif4jm.v)(params.provider, { manifestRegistry: params.manifestRegistry })?.normalizeConfig?.({
...
function applyProviderConfigDefaultsForConfig(params) {
  return (0, _thinkingCvQif4jm.v)(params.provider, { manifestRegistry: params.manifestRegistry })?.applyConfigDefaults?.({
    provider: params.provider,
...
function applyTalkConfigNormalization(config) {
  return (0, _talkEgZSwsfJ.n)(config);
}
  ...
  if (providerConfig) {
    ...
    for (const [providerId, provider] of Object.entries(providerConfig)) {
      ...
      const nextModels = models.map((model) => {
        ...
        const id = (0, _modelRefSharedDTXcmZXB.r)(providerId, raw.id);
...
function resolveShellEnvExpectedKeys(env) {
  return [...new Set([
  ...(0, _providerEnvVarsCDIyh39z.n)({ env }),
  ...(0, _channelEnvVarsKl6Wjoo.n)({ env }),
...
function validateIdentityAvatar(config) {
  ...
  for (const [index, entry] of agents.entries()) {
    ...
    if (!isWorkspaceAvatarPath(avatar, (0, _agentScopeConfigDUwbsKjv.o)(config, entry.id ?? (0, _agentScopeConfigDUwbsKjv.c)(config)))) issues.push({
      path: `agents.list.${index}.identity.avatar`,
...
function validateConfigObjectRaw(raw, opts) {
  ...
  const validated = _zodSchemaB8qk5q8o.t.safeParse(normalizedRaw);
...
function validateConfigObjectWithPluginsBase(raw, opts) {
  ...
  const loadValidationRegistry = () => {
    ...
    registryInfo = { registry: (0, _pluginMetadataSnapshotBxWkpxUl.i)({
        config,
        workspaceDir: (0, _agentScopeConfigDUwbsKjv.o)(config, (0, _agentScopeConfigDUwbsKjv.c)(config)) ?? void 0,
  ...
  const ensureCompatConfig = () => {
    ...
    compatConfig = (0, _bundledCompatC5xrsnA.t)({
      config,
...
function warnIfConfigFromFuture(cfg, logger) {
  ...
  if (!touched) return;
  if ((0, _version8VAMXiY.r)(_versionB2G3zXnp.n, touched)) {
...
async function collectInvalidConfigLegacyIssues(raw, sourceRaw) {
  if (!raw || typeof raw !== "object") return [];
  const { findDoctorLegacyConfigIssues } = await Promise.resolve().then(() => jitiImport("./legacy-config-issues-B3KDmVKv.js").then((m) => _interopRequireWildcard(m)));
...
function createConfigIO(overrides = {}) {
  ...
  function migrateAndStripShippedPluginInstallConfigRecords(configRaw, options = {}) {
    ...
    try {
      ...
      const filePath = (0, _installedPluginIndexRecordsBEXTtiS.i)({
        env: deps.env,
        stateDir
      });
      ...
      if (Object.keys(installRecords).some((pluginId) => !(pluginId in existingRecords))) (0, _installedPluginIndexRecordsBEXTtiS.c)(nextRecords, {
  ...
  function ensureShippedPluginInstallConfigRecordsMigratedForWrite(snapshot) {
    ...
    try {
      (0, _installedPluginIndexRecordsBEXTtiS.c)({
        ...installRecords,
        ...existingRecords
      }, {
  ...
  function loadConfig() {
    try {
      ...
      const loadValidationPluginMetadataSnapshot = (config) => {
        ...
        pluginMetadataSnapshot = (0, _pluginMetadataSnapshotBxWkpxUl.i)({
          config: metadataConfig,
          workspaceDir: (0, _agentScopeConfigDUwbsKjv.o)(metadataConfig, (0, _agentScopeConfigDUwbsKjv.c)(metadataConfig)),
          env: deps.env
        });
  ...
  async function writeConfigFile(cfg, options = {}) {
    ...
    const logConfigOverwrite = () => {
      ...
      if (!(0, _loggerApTu_tEr.b)() && deps.env.OPENCLAW_CONFIG_OVERWRITE_LOG !== "1" && !shouldLogInVitest) return;
...
function registerConfigWriteListener(listener) {
  return (0, _runtimeSnapshotBCdniHcd.d)(listener);
}
...
function projectConfigOntoRuntimeSourceSnapshot(config) {
  const runtimeConfigSnapshot = (0, _runtimeSnapshotBCdniHcd.i)();
  const runtimeConfigSourceSnapshot = (0, _runtimeSnapshotBCdniHcd.s)();
...
function loadConfig() {
  return (0, _runtimeSnapshotBCdniHcd.l)(() => createConfigIO().loadConfig());
}
...
async function writeConfigFile(cfg, options = {}) {
  ...
  if (options.skipRuntimeSnapshotRefresh && !hadRuntimeSnapshot && !(0, _runtimeSnapshotBCdniHcd.o)()) return writeResult;
  ...
  const notifyCommittedWrite = () => {
    const currentRuntimeConfig = (0, _runtimeSnapshotBCdniHcd.i)();
    if (!currentRuntimeConfig) return;
    (0, _runtimeSnapshotBCdniHcd.u)((0, _runtimeSnapshotBCdniHcd.n)({
  ...
  await (0, _runtimeSnapshotBCdniHcd.r)({
