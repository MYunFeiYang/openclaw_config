"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.monitorState = exports.WebhookMonitorState = exports.StreamStore = exports.LIMITS = exports.ActiveReplyStore = void 0;
...
// 常量
// ============================================================================
const LIMITS = exports.LIMITS = { STREAM_TTL_MS: 10 * 60 * 1000, ACTIVE_REPLY_TTL_MS: 60 * 60 * 1000, DEFAULT_DEBOUNCE_MS: 500, STREAM_MAX_BYTES: 20_480,
...
class StreamStore {
   ...
   */
  createStream(params) {
    const streamId = _nodeCrypto.default.randomBytes(16).toString("hex");
    if (params.msgid) {
...
const monitorState = exports.monitorState = new WebhookMonitorState(); /* v9-f83c168c68f1c804 */
