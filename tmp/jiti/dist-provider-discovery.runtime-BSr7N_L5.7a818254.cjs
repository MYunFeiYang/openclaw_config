"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = resolvePluginDiscoveryProvidersRuntime;var _pluginModuleLoaderCacheAuBzBauz = require("./plugin-module-loader-cache-AuBzBauz.js");
var _manifestContractEligibilityBs7SHB8Y = require("./manifest-contract-eligibility-Bs7SHB8Y.js");
...
function createPluginSourceLoader() {
  const loaders = (0, _pluginModuleLoaderCacheAuBzBauz.t)();
  return (modulePath) => {
    const sourceLoader = (0, _pluginModuleLoaderCacheAuBzBauz.r)({
      cache: loaders,
      modulePath,
      importerUrl: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/provider-discovery.runtime-BSr7N_L5.js",
      loaderFilename: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/provider-discovery.runtime-BSr7N_L5.js"
    });
...
function resolveProviderDiscoveryEntryPlugins(params) {
  const metadataSnapshot = params.pluginMetadataSnapshot ?? (0, _manifestContractEligibilityBs7SHB8Y.s)({
  ...
  const pluginIds = (0, _pluginAutoEnableQ8Kl1Dsn.u)({
    ...params,
    registry,
    manifestRegistry
  });
...
function resolvePluginDiscoveryProvidersRuntime(params) {
  ...
  if (params.onlyPluginIds === void 0 && entryResult.providers.length > 0) {
    ...
    const fullProviders = fullPluginIds.length > 0 ? (0, _providersRuntimeKg4pVITC.n)({
      ...params,
      env,
