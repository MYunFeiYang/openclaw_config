...
function logWithSubsystem(params) {
  ...
  if (parsed) {
    (0, _subsystemLmgZvqF.t)(parsed.subsystem)[params.subsystemMethod](parsed.rest);
    return;
  }
  params.runtime[params.runtimeMethod](params.runtimeFormatter(params.message));
  (0, _loggerApTu_tEr.a)()[params.loggerMethod](params.message);
}
...
function logDebug(message) {
  (0, _loggerApTu_tEr.a)().debug(message);
  if ((0, _loggerApTu_tEr.b)()) console.log(_themeCStEj1vt.r.muted(message));
}
//#endregion /* v9-cf15969596e8ab9a */
