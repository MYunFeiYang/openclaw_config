"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveImageSanitizationLimits;exports.n = sanitizeImageBlocks;exports.r = sanitizeToolResultImages;exports.t = sanitizeContentBlocksImages;var _subsystemLmgZvqF = require("./subsystem-LmgZvqF7.js");
var _base64SD6TLy = require("./base64-s-D6TLy9.js");
var _mediaServicesDi9wZ6pu = require("./media-services-Di9wZ6pu.js");
...
const log = (0, _subsystemLmgZvqF.t)("agents/tool-images");
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const meta = await (0, _mediaServicesDi9wZ6pu.c)(buf);
  ...
  const sideGrid = (0, _mediaServicesDi9wZ6pu.o)(params.maxDimensionPx, sideStart);
  let smallest = null;
  let processorUnavailableError;
  for (const side of sideGrid) {
    for (const quality of _mediaServicesDi9wZ6pu.r) {
      let out;
      try {
        out = await (0, _mediaServicesDi9wZ6pu.p)({
          buffer: buf,
          maxSide: side,
          quality,
        ...
        if ((0, _mediaServicesDi9wZ6pu.u)(err)) {
...
async function sanitizeContentBlocksImages(blocks, label, opts = {}) {
  ...
  for (const block of blocks) {
    ...
    const canonicalData = (0, _base64SD6TLy.t)(data);
    if (!canonicalData) {
      out.push({
        type: "text",
