"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.getRegisteredTargets = getRegisteredTargets;exports.getWebhookTargetsMap = getWebhookTargetsMap;exports.hasActiveTargets = hasActiveTargets;exports.parseWebhookPath = parseWebhookPath;exports.registerWecomWebhookTarget = registerWecomWebhookTarget; /**
 * Webhook Target 管理
 *
...
function registerTargetForPath(path, target) {
  ...
  return () => {
    ...
    if (updated.length > 0)
    webhookTargets.set(key, updated);else
