"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.mediaInterceptor = void 0;
...
var _openclawCompat = require("../../openclaw-compat.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);} /**
 * get_msg_media 响应拦截器
 *
 * 核心逻辑：
...
// 拦截器实现
// ============================================================================
const mediaInterceptor = exports.mediaInterceptor = { name: "media", /** 仅对 get_msg_media 方法生效 */match: (ctx) => ctx.method === "get_msg_media", /** 设置延长的超时时间 */beforeCall() {return { timeoutMs: _transport.MEDIA_DOWNLOAD_TIMEOUT_MS };},
  /** 拦截响应：base64 → 本地文件 */
...
async function interceptMediaResponse(result) {
  ...
  const contentType = (await (0, _openclawCompat.detectMime)({ buffer, filePath: mediaName })) ?? "application/octet-stream";
