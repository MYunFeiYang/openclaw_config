"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.smartpageExportInterceptor = void 0;
...
// 拦截器实现
// ============================================================================
const smartpageExportInterceptor = exports.smartpageExportInterceptor = { name: "smartpage-export", /** 仅对 doc 品类的 smartpage_get_export_result 方法生效 */match: (ctx) => ctx.category === "doc" && ctx.method === "smartpage_get_export_result", /** 拦截响应：将 markdown content 保存为本地文件 */async afterCall(_ctx, result) {return interceptExportResponse(result);} }; // ============================================================================
// 内部实现
// ============================================================================
/**
 ...
 */async function interceptExportResponse(result) {// 1. 提取 MCP result 中的 content 数组
  const content = result?.content;if (!Array.isArray(content)) return result;
