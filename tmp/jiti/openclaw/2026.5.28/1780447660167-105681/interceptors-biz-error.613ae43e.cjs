"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.bizErrorInterceptor = void 0;
...
// 拦截器实现
// ============================================================================
const bizErrorInterceptor = exports.bizErrorInterceptor = { name: "biz-error", /** 对所有 call 调用生效 */match: () => true, /** 检查返回结果中的业务错误码，必要时清理缓存 */afterCall(ctx, result) {
  ...
  for (const item of content) {
    ...
    try {
      ...
      if (typeof parsed.errcode === "number" && BIZ_CACHE_CLEAR_ERROR_CODES.has(parsed.errcode)) {
        ...
        (0, _transport.clearCategoryCache)(accountId, ctx.category);
        return;
      }
    }
    catch {
