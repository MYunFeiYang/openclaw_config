"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.docAuthErrorInterceptor = void 0;
...
// 常量
// ============================================================================
/** 需要拦截的文档授权错误码集合 */ /* https://doc.weixin.qq.com/sheet/e3_AFcARgbdAFwCNU0pwubawRtGzcd6z?scode=AJEAIQdfAAoEpqtRfRAMEA4QYkACk&tab=BB08J2 */const DOC_AUTH_ERROR_CODES = new Set([851013, 851014, 851008]); /**
...
// 拦截器实现
// ============================================================================
const docAuthErrorInterceptor = exports.docAuthErrorInterceptor = {
  name: "doc-auth-error",
  /** 仅对 doc 品类生效 */
...
async function sendBizMsg(params) {
  const accountId = params.accountId || (0, _transport.resolveCurrentAccountId)();
  ...
  const reqId = (0, _aibotNodeSdk.generateReqId)("biz_msg");
  ...
  try {
    await (0, _timeout.withTimeout)(wsClient.reply({ headers: { req_id: reqId } }, body, _const.AIBOT_SEND_BIZ_MSG_CMD), _const.BIZ_MSG_SEND_TIMEOUT_MS, `aibot_send_biz_msg timed out after ${_const.BIZ_MSG_SEND_TIMEOUT_MS}ms`);
