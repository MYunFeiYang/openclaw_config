"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = isGroupReadable;exports.c = isWorldWritable;exports.d = createIcaclsResetCommand;exports.f = formatIcaclsResetCommand;exports.i = inspectPathPermissions;exports.l = modeBits;exports.n = formatPermissionDetail;exports.o = isGroupWritable;exports.r = formatPermissionRemediation;exports.s = isWorldReadable;exports.t = formatOctal;exports.u = safeStat;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
var _exec2P596n4G = require("./exec-2P596n4G.js");
...
const normalize = (value) => (0, _stringCoerceBje8XVt.a)(value);
function normalizeSid(value) {
  const normalized = normalize(value);
  return normalized.startsWith("*") ? normalized.slice(1) : normalized;
}
function resolveWindowsUserPrincipal(env) {
  const username = env?.USERNAME?.trim() || _nodeOs.default.userInfo().username?.trim();
...
function resolveWindowsSystemCommand(command, env) {
  ...
  return root ? _nodePath.default.win32.join(root, "System32", command) : command;
}
...
async function inspectWindowsAcl(targetPath, opts) {
  const exec = opts?.exec ?? _exec2P596n4G.i;
  try {
