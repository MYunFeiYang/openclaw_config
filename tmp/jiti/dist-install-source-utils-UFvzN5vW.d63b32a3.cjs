...
var _npmInstallEnvSJ_Ugrx_ = require("./npm-install-env-SJ_Ugrx_.js");
...
function createNpmMetadataEnv() {
  ...
  (0, _npmInstallEnvSJ_Ugrx_.t)(env);
  return env;
}
...
async function resolveNpmSpecMetadata(params) {
  const res = await (0, _execDxBD2Ybt.r)([
  "npm",
  "view",
  params.spec,
  "name",
