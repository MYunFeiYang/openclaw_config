...
var _networkModeZpvgewgn = require("./network-mode-zpvgewgn.js");
...
const HeartbeatSchema = exports.c = (0, _schemasBmna8ihM.Tn)({
  ...
  if (!val.every) return;
  try {
    (0, _parseDurationUDFt9RSx.t)(val.every, { defaultUnit: "m" });
  } catch {
    ctx.addIssue({
...
const SandboxDockerSchema = (0, _schemasBmna8ihM.Tn)({
  ...
  if (data.binds) for (let i = 0; i < data.binds.length; i += 1) {
    ...
    const parsed = (0, _networkModeZpvgewgn.c)(bind);
    const source = (parsed ? parsed.host : bind).trim();
    if (!(0, _networkModeZpvgewgn.a)(source)) ctx.addIssue({
      code: _compatZe2wFLca.n.custom,
      path: ["binds", i],
  ...
  const blockedNetworkReason = (0, _networkModeZpvgewgn.t)({
...
const SandboxSshSchema = (0, _schemasBmna8ihM.Tn)({
  ...
  identityData: _zodSchemaCoreBmdNbTg.C.optional().register(_zodSchemaSensitiveCoJ4c6Os.t),
  certificateData: _zodSchemaCoreBmdNbTg.C.optional().register(_zodSchemaSensitiveCoJ4c6Os.t),
  knownHostsData: _zodSchemaCoreBmdNbTg.C.optional().register(_zodSchemaSensitiveCoJ4c6Os.t)
}).strict().optional();
...
const AgentEntrySchema = exports.r = (0, _schemasBmna8ihM.Tn)({
  ...
  identity: _zodSchemaCoreBmdNbTg.f,
...
const ToolsSchema = exports.d = (0, _schemasBmna8ihM.Tn)({
  ...CommonToolPolicyFields,
  web: ToolsWebSchema,
  media: _zodSchemaCoreBmdNbTg.O,
  links: _zodSchemaCoreBmdNbTg.D,
