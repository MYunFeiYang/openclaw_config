...
const log = exports.f = (0, _subsystemLmgZvqF.t)("agents/auth-profiles");
//#endregion
...
function readCachedAuthProfileStore(params) {
  ...
  return (0, _runtimeSnapshotsCbKCG9ZW.g)(cached.store);
}
function writeCachedAuthProfileStore(params) {
  loadedAuthStoreCache.set(params.authPath, {
    ...
    syncedAtMs: Date.now(),
    store: (0, _runtimeSnapshotsCbKCG9ZW.g)(params.store)
  });
}
function clearLoadedAuthStoreCache() {
  loadedAuthStoreCache.clear();
}
//#endregion /* v9-05fb4acd59b96c17 */
