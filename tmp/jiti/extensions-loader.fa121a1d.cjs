...
var _jiti = require("@mariozechner/jiti");
var _bundledPiAgentCore = _interopRequireWildcard(require("@mariozechner/pi-agent-core"));
var _bundledPiAi = _interopRequireWildcard(require("@mariozechner/pi-ai"));
var _bundledPiAiOauth = _interopRequireWildcard(require("@mariozechner/pi-ai/oauth"));
var _bundledPiTui = _interopRequireWildcard(require("@mariozechner/pi-tui"));



var _bundledTypebox = _interopRequireWildcard(require("typebox"));
var _bundledTypeboxCompile = _interopRequireWildcard(require("typebox/compile"));
var _bundledTypeboxValue = _interopRequireWildcard(require("typebox/value"));
var _config = require("../../config.js");


var _bundledPiCodingAgent = _interopRequireWildcard(require("../../index.js"));
var _eventBus = require("../event-bus.js");
var _exec = require("../exec.js");
var _sourceInfo = require("../source-info.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);} /**
...
/** Modules available to extensions via virtualModules (for compiled Bun binary) */const VIRTUAL_MODULES = { typebox: _bundledTypebox, "typebox/compile": _bundledTypeboxCompile, "typebox/value": _bundledTypeboxValue, "@sinclair/typebox": _bundledTypebox, "@sinclair/typebox/compile": _bundledTypeboxCompile, "@sinclair/typebox/value": _bundledTypeboxValue, "@mariozechner/pi-agent-core": _bundledPiAgentCore,
  "@mariozechner/pi-tui": _bundledPiTui,
  "@mariozechner/pi-ai": _bundledPiAi,
  "@mariozechner/pi-ai/oauth": _bundledPiAiOauth,
  "@mariozechner/pi-coding-agent": _bundledPiCodingAgent
};
const _require = (0, _nodeModule.createRequire)("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/node_modules/@mariozechner/pi-coding-agent/dist/core/extensions/loader.js");
/**
...
function getAliases() {
  if (_aliases)
  return _aliases;
  const __dirname = path.dirname((0, _nodeUrl.fileURLToPath)("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/node_modules/@mariozechner/pi-coding-agent/dist/core/extensions/loader.js"));
...
async function loadExtensionModule(extensionPath) {
  const jiti = (0, _jiti.createJiti)("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/node_modules/@mariozechner/pi-coding-agent/dist/core/extensions/loader.js", {
    moduleCache: false,
 ...
 */
async function discoverAndLoadExtensions(configuredPaths, cwd, agentDir = (0, _config.getAgentDir)(), eventBus) {
  const allPaths = [];
  const seen = new Set();
  ...
  const localExtDir = path.join(cwd, _config.CONFIG_DIR_NAME, "extensions");
