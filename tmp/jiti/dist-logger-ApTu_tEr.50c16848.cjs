"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.C = setYes;exports.S = setVerbose;exports._ = levelToMinLevel;exports.a = getLogger;exports.b = isVerbose;exports.c = resetLogger;exports.d = toPinoLikeLogger;exports.f = formatLocalIsoWithOffset;exports.g = void 0;exports.h = resolveEnvLogLevelOverride;exports.i = getChildLogger;exports.l = setLoggerConfigLoaderForTests;exports.m = isValidTimeZone;exports.n = void 0;exports.o = getResolvedLoggerSettings;exports.p = formatTimestamp;exports.r = void 0;exports.s = isFileLogLevelEnabled;exports.t = void 0;exports.u = setLoggerOverride;exports.v = normalizeLogLevel;exports.x = isYes;exports.y = tryParseLogLevel;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
var _diagnosticEventsCyaAsfPZ = require("./diagnostic-events-CyaAsfPZ.js");
...
function normalizeTraceContext(value) {
  ...
  if (!(0, _diagnosticEventsCyaAsfPZ.v)(candidate.traceId)) return;
  if (candidate.spanId !== void 0 && !(0, _diagnosticEventsCyaAsfPZ.g)(candidate.spanId)) return;
  if (candidate.parentSpanId !== void 0 && !(0, _diagnosticEventsCyaAsfPZ.g)(candidate.parentSpanId)) return;
  if (candidate.traceFlags !== void 0 && !(0, _diagnosticEventsCyaAsfPZ._)(candidate.traceFlags)) return;
  return {
...
function buildTraceFileLogFields(logObj) {
  ...
  const trace = findLogTraceContext(bindings, args) ?? (0, _diagnosticEventsCyaAsfPZ.h)();
  if (!trace) return;
  return {
...
function buildDiagnosticLogRecord(logObj) {
  ...
  const trace = findLogTraceContext(bindings, numericArgs) ?? (0, _diagnosticEventsCyaAsfPZ.h)();
...
function attachDiagnosticEventTransport(logger) {
  logger.attachTransport((logObj) => {
    try {
      (0, _diagnosticEventsCyaAsfPZ.n)(buildDiagnosticLogRecord(redactLogRecordForTransport(logObj)));
    } catch {}
  });
}
