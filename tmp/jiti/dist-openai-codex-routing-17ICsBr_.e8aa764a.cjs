...
function shouldRouteOpenAIPiThroughCodexAuthProvider(params) {
  ...
  return (0, _providerAuthAliasesCljpontN.r)(params.authProfileProvider ?? params.authProfileId?.split(":", 1)[0] ?? "", aliasLookupParams) === OPENAI_CODEX_PROVIDER_ID;
}
