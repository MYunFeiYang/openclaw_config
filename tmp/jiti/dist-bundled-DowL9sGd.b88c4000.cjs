...
var _bundledPluginMetadataAWw5TsmM = require("./bundled-plugin-metadata-AWw5TsmM.js");
...
const nodeRequire = (0, _nodeModule.createRequire)("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-DowL9sGd.js");
...
function loadModuleWithJiti(modulePath) {
  return (0, _pluginModuleLoaderCacheAuBzBauz.n)({
    cache: jitiLoaders,
    modulePath,
    importerUrl: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-DowL9sGd.js",
    loaderFilename: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-DowL9sGd.js",
    tryNative: false,
    cacheScopeKey: "channel-plugin-module-loader"
  })(modulePath);
}
function loadModule(modulePath) {
  if (!(0, _pluginModuleLoaderCacheAuBzBauz.a)(modulePath) && !hasNativeSourceRequireHook(modulePath)) {
...
const OPENCLAW_PACKAGE_ROOT = (0, _openclawRootDDaGBMF_.n)({
  ...
  cwd: process.cwd(),
  moduleUrl: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-DowL9sGd.js".startsWith("file:") ? "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-DowL9sGd.js" : void 0
}) ?? ("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-DowL9sGd.js".startsWith("file:") ? _nodePath.default.resolve((0, _nodeUrl.fileURLToPath)(new URL("../../..", "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-DowL9sGd.js"))) : process.cwd());
...
function listBundledChannelPluginMetadata(params) {
  ...
  return (0, _pluginRegistryIimloLsx.n)({
...
function resolveBundledChannelGeneratedPath(rootDir, entry, pluginDirName, scanDir) {
  return (0, _bundledPluginMetadataAWw5TsmM.t)(rootDir, entry, pluginDirName, scanDir);
}
//#endregion
...
const log = (0, _subsystemLmgZvqF.t)("channels");
