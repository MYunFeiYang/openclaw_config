"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.C = createPluginGatewayMethodDescriptors;exports.E = resolvePluginActivationSourceConfig;exports.S = createGatewayMethodRegistry;exports.T = getCompactionProvider;exports._ = getPluginSessionExtensionStateSync;exports.a = clearPluginRegistryLoadCache;exports.b = listCodexAppServerExtensionFactories;exports.c = loadOpenClawPluginCliRegistry;exports.d = resolvePluginRegistryLoadCacheKey;exports.f = resolveRuntimePluginRegistry;exports.g = drainPluginNextTurnInjectionContext;exports.h = synthesizeMediaGenerationCatalogEntries;exports.i = clearPluginLoaderCache;exports.l = loadOpenClawPlugins;exports.m = listMediaGenerationProviderModels;exports.n = void 0;exports.o = getRuntimePluginRegistryForLoadOptions;exports.p = createPluginRegistry;exports.r = clearActivatedPluginRuntimeState;exports.s = isPluginRegistryLoadInFlight;exports.t = void 0;exports.u = resolveCompatibleRuntimePluginRegistry;exports.v = patchPluginSessionExtension;exports.w = void 0;exports.x = createGatewayMethodDescriptorsFromHandlers;exports.y = projectPluginSessionExtensionsSync;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
require("./agent-scope-Cf7T6Ju7.js");
...
var _manifestRegistryCFqIGq5y = require("./manifest-registry-CFqIGq5y.js");
var _pluginRegistryIimloLsx = require("./plugin-registry-iimloLsx.js");
var _pluginModuleLoaderCacheAuBzBauz = require("./plugin-module-loader-cache-AuBzBauz.js");
var _sdkAliasBOEr = require("./sdk-alias-BOEr7503.js");
var _subsystemLmgZvqF = require("./subsystem-LmgZvqF7.js");
require("./installed-plugin-index-records-BEXTtiS3.js");
var _runtimeSnapshotBCdniHcd = require("./runtime-snapshot-BCdniHcd.js");
...
var _registryBzhk9nmO = require("./registry-Bzhk9nmO.js");
var _dreamingUzNnbVJ = require("./dreaming-uzNnbVJ6.js");
var _detachedTaskRuntimeStateBfGUlR6z = require("./detached-task-runtime-state-BfGUlR6z.js");
var _bundleMcpDXatVQNF = require("./bundle-mcp-DXatVQNF.js");
var _typesBaOU_7l = require("./types-BaOU_7l0.js");
var _hookRunnerGlobalCKF4eCEZ = require("./hook-runner-global-CKF4eCEZ.js");
var _loaderChannelSetupBbMMOyz = require("./loader-channel-setup-BbMMOyz7.js");
var _memoryEmbeddingProvidersCB8LiTKl = require("./memory-embedding-providers-CB8LiTKl.js");
var _memoryStateCVl5QzvG = require("./memory-state-CVl5QzvG.js");
var _pluginLoadProfileC9eMiU = require("./plugin-load-profile-C9eMiU--.js");
var _runtimeNSi6iKFR = require("./runtime-nSi6iKFR.js");
var _registryCY4dANbm = require("./registry-CY4dANbm.js");
var _internalHooksCi62WSre = require("./internal-hooks-Ci62WSre.js");
...
var _toolContracts123vyhu = require("./tool-contracts-123vyhu4.js");
var _workspaceDirDF9GO5GC = require("./workspace-dir-DF9GO5GC.js");
var _mainSessionBIlePcj = require("./main-session-BIlePcj4.js");
var _combinedStoreGatewayDTxOYXKu = require("./combined-store-gateway-DTxOYXKu.js");
var _pathsRbVDOqFp = require("./paths-RbVDOqFp.js");
var _storeLoadDjaY7SAt = require("./store-load-DjaY7SAt.js");
var _storeCmwzJ9N = require("./store-CmwzJ9N6.js");
var _targetsDGxp4nvt = require("./targets-DGxp4nvt.js");
var _sessionsBDnaolrd = require("./sessions-BDnaolrd.js");
var _mimeDWfYSjGf = require("./mime-DWfYSjGf.js");
require("./host-hook-cleanup-DnaViAGN.js");
...
function resolvePluginActivationSourceConfig(params) {
  ...
  const sourceSnapshot = (0, _runtimeSnapshotBCdniHcd.s)();
  if (sourceSnapshot && params.config === (0, _runtimeSnapshotBCdniHcd.i)()) return sourceSnapshot;
...
function listCodexAppServerExtensionFactories() {
  return (0, _runtimeNSi6iKFR.a)()?.codexAppServerExtensionFactories?.map((entry) => entry.factory) ?? [];
}
//#endregion
...
async function loadSendMessage() {
  sendMessagePromise ??= Promise.resolve().then(() => jitiImport("./message-B3mwoFA7.js").then((m) => _interopRequireWildcard(m))).then((module) => module.sendMessage);
  return sendMessagePromise;
}
let getChannelPluginPromise;
async function loadGetChannelPlugin() {
  getChannelPluginPromise ??= Promise.resolve().then(() => jitiImport("./plugins-048uGBh8.js").then((m) => _interopRequireWildcard(m))).then((module) => module.getChannelPlugin);
...
function resolveAttachmentFilePath(params) {
  const workspaceDir = params.sessionKey && params.config ? (0, _agentScopeConfigDUwbsKjv.o)(params.config, (0, _sessionKeyCQewiu8n.u)(params.sessionKey)) : void 0;
...
async function sendPluginSessionAttachment(params) {
  ...
  const { deliveryContext, threadId } = (0, _sessionsBDnaolrd.u)(sessionKey, { cfg: params.config });
...
const log$1 = (0, _subsystemLmgZvqF.t)("plugins/host-scheduled-turns");
...
const log = (0, _subsystemLmgZvqF.t)("plugins/host-hook-state");
...
function resolveSessionStoreCandidates(params) {
  ...
  for (const target of (0, _targetsDGxp4nvt.i)(params.cfg)) if (target.agentId === params.agentId) targets.set(target.storePath, target);
...
function loadPluginHostHookSessionEntry(params) {
  ...
  const canonicalKey = (0, _combinedStoreGatewayDTxOYXKu.a)({
    cfg,
    sessionKey: key
  });
  const agentId = (0, _combinedStoreGatewayDTxOYXKu.i)(cfg, canonicalKey);
  ...
  let selectedMatch = findFreshestStoreMatch((0, _storeLoadDjaY7SAt.t)(fallback.storePath), ...scanTargets);
  for (let index = 1; index < candidates.length; index += 1) {
    const candidate = candidates[index];
    if (!candidate) continue;
    const match = findFreshestStoreMatch((0, _storeLoadDjaY7SAt.t)(candidate.storePath), ...scanTargets);
...
async function enqueuePluginNextTurnInjection(params) {
  ...
  await (0, _storeCmwzJ9N.s)(loaded.storePath, (store) => {
...
async function drainPluginNextTurnInjections(params) {
  ...
  const now = params.now ?? Date.now();
  return await (0, _storeCmwzJ9N.s)(loaded.storePath, (store) => {
    const entry = store[loaded.storeKey];
    if (!entry?.pluginNextTurnInjections) return [];
    const activePluginIds = new Set(((0, _runtimeNSi6iKFR.a)()?.plugins ?? []).filter((plugin) => plugin.status === "loaded").map((plugin) => plugin.id));
    const drained = [];
...
async function drainPluginNextTurnInjectionContext(params) {
  ...
  return {
    queuedInjections,
    ...(0, _runtimeNSi6iKFR.N)({ queuedInjections })
  };
}
...
async function patchPluginSessionExtension(params) {
  ...
  const registration = ((0, _runtimeNSi6iKFR.a)()?.sessionExtensions ?? []).find((entry) => entry.pluginId === pluginId && entry.extension.namespace === namespace);
  ...
  const normalizedSlotKey = rawSlotKey ? (0, _storeLoadDjaY7SAt.o)(rawSlotKey) : void 0;
  ...
  return {
    ok: true,
    key: canonicalKey,
    value: await (0, _storeCmwzJ9N.s)(loaded.storePath, (store) => {
      const entry = store[loaded.storeKey];
      if (!entry) return;
      ...
      const previousSlotKey = (0, _storeLoadDjaY7SAt.o)(pluginSlotKeys[namespace]);
...
function projectPluginSessionExtensionsSync(params) {
  const extensions = (0, _runtimeNSi6iKFR.a)()?.sessionExtensions ?? [];
...
const LEGACY_DEACTIVATE_HOOK_ALIAS_COMPAT = (0, _installedPluginIndexStoreIOgCdyHd.v)("legacy-deactivate-hook-alias");
...
const constrainLegacyPromptInjectionHook = (handler) => {
  return (event, ctx) => {
    ...
    if (result && typeof result === "object" && "then" in result) return Promise.resolve(result).then((resolved) => (0, _typesBaOU_7l.l)(resolved));
    return (0, _typesBaOU_7l.l)(result);
  };
};
...
function createPluginRegistry(registryParams) {
  const registry = (0, _runtimeNSi6iKFR.F)();
  ...
  const registerAgentToolResultMiddleware = (record, handler, options) => {
    ...
    const runtimes = (0, _toolContracts123vyhu.o)(options);
    ...
    const declared = (0, _toolContracts123vyhu.a)(record.contracts?.agentToolResultMiddleware);
  ...
  const registerTool = (record, tool, opts) => {
    ...
    const declaredNames = (0, _toolContracts123vyhu.n)(record.contracts);
    ...
    const normalized = (0, _toolContracts123vyhu.r)(names);
    const undeclared = (0, _toolContracts123vyhu.t)({
      declaredNames,
  ...
  const registerHook = (record, events, handler, opts, config, pluginConfig) => {
    ...
    for (const registration of previousRegistrations) (0, _internalHooksCi62WSre.h)(registration.event, registration.handler);
    ...
    for (const event of normalizedEvents) {
      ...
      (0, _internalHooksCi62WSre.f)(event, wrappedHandler);
  ...
  const registerAgentHarness$1 = (record, harness) => {
    ...
    const existing = registryParams.activateGlobalSideEffects === false ? registry.agentHarnesses.find((entry) => entry.harness.id === id) : (0, _registryBzhk9nmO.r)(id);
    if (existing) {
    ...
    if (registryParams.activateGlobalSideEffects !== false) (0, _registryBzhk9nmO.o)(normalizedHarness, { ownerPluginId: record.id });
  ...
  const registerCommand = (record, command) => {
    ...
    if (allowReservedCommandNames && !(0, _typesBaOU_7l.u)(name)) {
      pushDiagnostic({
        level: "error",
        pluginId: record.id,
        source: record.source,
    ...
    if (!registryParams.activateGlobalSideEffects) {
      const validationError = (0, _typesBaOU_7l.h)(command, { allowReservedCommandNames });
      if (validationError) {
        pushDiagnostic({
          level: "error",
          pluginId: record.id,
      ...
      const result = (0, _typesBaOU_7l.p)(record.id, allowReservedCommandNames ? commandForRegistration : command, {
        pluginName: record.name,
      ...
      if (allowReservedCommandNames) {
        const registeredCommand = _typesBaOU_7l.A.get(`/${name.toLowerCase()}`);
  ...
  const normalizeHostHookString = (value) => typeof value === "string" ? (0, _runtimeNSi6iKFR.P)(value) : "";
  ...
  const registerSessionExtension = (record, extension) => {
    ...
    if (extension.sessionEntrySlotKey !== void 0) {
      const slotKey = (0, _storeLoadDjaY7SAt.o)(extension.sessionEntrySlotKey);
    ...
    if (normalizedSessionEntrySlotKey) {
      if ((registry.sessionExtensions ?? []).find((entry) => {
        ...
        const normalizedExistingSlotKey = (0, _storeLoadDjaY7SAt.o)(existingSlotKey);
  ...
  const registerToolMetadata = (record, metadata) => {
    ...
    const undeclared = (0, _toolContracts123vyhu.t)({
      declaredNames: (0, _toolContracts123vyhu.n)(record.contracts),
      toolNames: [toolName]
    });
    if (undeclared.length > 0) {
      pushDiagnostic({
  ...
  const registerRuntimeLifecycle = (record, lifecycle) => {
    const id = (0, _runtimeNSi6iKFR.P)(lifecycle.id);
    if (!id) {
      pushDiagnostic({
        level: "error",
        pluginId: record.id,
  ...
  const registerAgentEventSubscription = (record, subscription) => {
    const id = (0, _runtimeNSi6iKFR.P)(subscription.id);
  ...
  const registerSessionSchedulerJob = (record, job) => {
    ...
    const handle = (0, _runtimeNSi6iKFR.A)({
      pluginId: record.id,
      pluginName: record.name,
    ...
    (registry.sessionSchedulerJobs ??= []).push({
      ...
      generation: (0, _runtimeNSi6iKFR.O)({
        pluginId: record.id,
        jobId: handle.id,
        sessionKey: handle.sessionKey
      }),
  ...
  const registerTypedHook = (record, hookName, handler, opts, policy) => {
    ...
    if (policy?.allowPromptInjection === false && (0, _typesBaOU_7l.s)(effectiveHookName)) {
    ...
    if ((0, _typesBaOU_7l.a)(effectiveHookName)) {
  ...
  const createApi = (record, params) => {
    ...
    const isLoadedRecordInActiveRegistry = () => (0, _runtimeNSi6iKFR.a)() === registry && isLoadedRecordInRegistry();
    ...
    const shouldCommitWorkflowSideEffect = () => sideEffectGuard.active && !(0, _runtimeNSi6iKFR.C)(registry) && (isActivatingLoadedRecord() || (0, _runtimeNSi6iKFR.S)(registry) && isLoadedRecordInRegistry());
      ...
      handlers: {
        ...(registrationCapabilities.capabilityHandlers ? {
          ...
          registerInteractiveHandler: (registration) => {
            const result = (0, _typesBaOU_7l.y)(record.id, registration, {
              pluginName: record.name,
              pluginRoot: record.rootDir
            });
          ...
          setRunContext: (patch) => registryParams.activateGlobalSideEffects !== false && shouldCommitWorkflowSideEffect() ? (0, _runtimeNSi6iKFR.j)({
            pluginId: record.id,
            patch
          }) : false,
          getRunContext: (get) => (0, _runtimeNSi6iKFR.D)({
            pluginId: record.id,
            get
          }),
          clearRunContext: (params) => {
            if (registryParams.activateGlobalSideEffects === false || !shouldCommitWorkflowSideEffect()) return;
            (0, _runtimeNSi6iKFR.T)({
              pluginId: record.id,
              runId: params.runId,
          ...
          registerMemoryCapability: (capability) => {
            ...
            (0, _memoryStateCVl5QzvG.f)(record.id, capability);
          },
          registerMemoryPromptSection: (builder) => {
            ...
            (0, _memoryStateCVl5QzvG._)(record.id, builder);
          },
          registerMemoryPromptSupplement: (builder) => {
            ...
            (0, _memoryStateCVl5QzvG.v)(record.id, builder);
          },
          registerMemoryCorpusSupplement: (supplement) => {
            (0, _memoryStateCVl5QzvG.p)(record.id, supplement);
          },
          registerMemoryFlushPlan: (resolver) => {
            ...
            (0, _memoryStateCVl5QzvG.h)(record.id, resolver);
          },
          registerMemoryRuntime: (runtime) => {
            ...
            (0, _memoryStateCVl5QzvG.b)(record.id, runtime);
          },
  ...
  const rollbackPluginGlobalSideEffects = (pluginId) => {
    ...
    if (registryParams.activateGlobalSideEffects === false) return;
    (0, _typesBaOU_7l.E)(pluginId);
    (0, _typesBaOU_7l._)(pluginId);
    ...
    for (const entry of hookRollbackEntries.toReversed()) {
      ...
      for (const registration of activeRegistrations) (0, _internalHooksCi62WSre.h)(registration.event, registration.handler);
      if (entry.previousRegistrations.length === 0) {
        activePluginHookRegistrations.delete(entry.name);
        continue;
      }
      for (const registration of entry.previousRegistrations) (0, _internalHooksCi62WSre.f)(registration.event, registration.handler);
...
function resolveDreamingSidecarEngineId(params) {
  ...
  return (0, _dreamingUzNnbVJ.G)({
    pluginConfig: (0, _dreamingUzNnbVJ.K)(params.cfg),
    cfg: params.cfg
  }).enabled ? _dreamingUzNnbVJ._ : null;
}
...
const defaultLogger = () => (0, _subsystemLmgZvqF.t)("plugins");
...
function createPluginModuleLoader(options) {
  const moduleLoaders = (0, _pluginModuleLoaderCacheAuBzBauz.t)();
  const createLoaderForModule = (modulePath) => {
    return (0, _pluginModuleLoaderCacheAuBzBauz.n)({
      cache: moduleLoaders,
      modulePath,
      importerUrl: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/loader-CxUWY2_6.js",
      loaderFilename: modulePath,
      aliasMap: (0, _sdkAliasBOEr.t)(modulePath, process.argv[1], "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/loader-CxUWY2_6.js", options.pluginSdkResolution),
      pluginSdkResolution: options.pluginSdkResolution
    });
  };
  return (modulePath) => createLoaderForModule(modulePath)((0, _pluginModuleLoaderCacheAuBzBauz.s)(modulePath));
}
...
const __testing = exports.n = {
  ...
  shouldLoadChannelPluginInSetupRuntime: _loaderChannelSetupBbMMOyz.o,
  shouldPreferNativeModuleLoad: _sdkAliasBOEr.g,
  toSafeImportPath: _pluginModuleLoaderCacheAuBzBauz.s,
...
function buildCacheKey(params) {
  const discoveryContext = (0, _pluginRegistryIimloLsx.w)({
    workspaceDir: params.workspaceDir,
  ...
  return `${roots.workspace ?? ""}::${roots.global ?? ""}::${roots.stock ?? ""}::${JSON.stringify({
    bundledPackage,
    discoveryFingerprint: (0, _pluginRegistryIimloLsx.S)(discoveryContext),
    ...params.plugins,
    installs,
    loadPaths,
...
function resolvePluginRegistrationPlan(params) {
  ...
  if (params.shouldLoadModules && !params.validateOnly && (0, _loaderChannelSetupBbMMOyz.o)({
...
function getCompatibleActivePluginRegistry(options = {}) {
  const activeRegistry = (0, _runtimeNSi6iKFR.a)() ?? void 0;
  if (!activeRegistry) return;
  if (!hasExplicitCompatibilityInputs(options)) return activeRegistry;
  const activeCacheKey = (0, _runtimeNSi6iKFR.o)();
  ...
  if (loadContext.runtimeSubagentMode === "default" && (0, _runtimeNSi6iKFR.l)() === "gateway-bindable") {
...
function activatePluginRegistry(registry, cacheKey, runtimeSubagentMode, workspaceDir) {
  const preserveGatewayHookRunner = runtimeSubagentMode === "default" && (0, _runtimeNSi6iKFR.l)() === "gateway-bindable" && (0, _hookRunnerGlobalCKF4eCEZ.t)() !== null;
  (0, _runtimeNSi6iKFR.x)(registry, cacheKey, runtimeSubagentMode, workspaceDir);
  if (!preserveGatewayHookRunner) (0, _hookRunnerGlobalCKF4eCEZ.i)(registry);
}
function loadOpenClawPlugins(options = {}) {
  ...
  if (requestedOnlyPluginIdSet && requestedOnlyPluginIdSet.size === 0) {
    const emptyRegistry = (0, _runtimeNSi6iKFR.F)();
  ...
  if (cacheEnabled) {
    ...
    if (cached) {
      if (shouldActivate) {
        (0, _registryBzhk9nmO.c)(cached.state.agentHarnesses);
        (0, _typesBaOU_7l.j)(cached.state.commands ?? []);
  ...
  try {
    ...
    const discovery = suppliedManifestRegistry ? {
      ...
      diagnostics: []
    } : (0, _discoveryBNk7kgJV.t)({
      workspaceDir: options.workspaceDir,
      extraPaths: normalized.loadPaths,
      env,
      installRecords
    });
    const manifestRegistry = suppliedManifestRegistry ?? (0, _manifestRegistryCFqIGq5y.t)({
      config: cfg,
      workspaceDir: options.workspaceDir,
      env,
    ...
    for (const candidate of orderedCandidates) {
      ...
      const activationState = (0, _configStateCOhlckC.l)({
        ...
        config: normalized,
        rootConfig: cfg,
        enabledByDefault: (0, _installedPluginIndexStoreIOgCdyHd.g)(manifestRecord),
        activationSource,
      ...
      if (existingOrigin) {
        const record = createPluginRecord({
          ...
          enabled: false,
          compat: (0, _installedPluginIndexStoreIOgCdyHd.p)(manifestRecord),
          activationState,
      ...
      if (record.format === "bundle") {
        ...
        if (enableState.enabled && record.rootDir && record.bundleFormat && (record.bundleCapabilities ?? []).includes("mcpServers")) {
          const runtimeSupport = (0, _bundleMcpDXatVQNF.n)({
            pluginId: record.id,
            rootDir: record.rootDir,
      ...
      try {
        (0, _runtimeNSi6iKFR.p)(record.id);
      ...
      if (registrationPlan.loadSetupEntry && manifestRecord.setupSource) {
        const setupRegistration = (0, _loaderChannelSetupBbMMOyz.a)(mod);
        ...
        if (setupRegistration.plugin) {
          if (!(0, _loaderChannelSetupBbMMOyz.t)({
          ...
          if (registrationPlan.loadSetupRuntimeEntry && setupRegistration.usesBundledSetupContract && resolveCanonicalDistRuntimeSource(runtimeCandidateEntry.source) !== safeSource) {
            ...
            const runtimeRegistration = (0, _loaderChannelSetupBbMMOyz.i)(runtimeMod);
            ...
            const runtimePluginRegistration = (0, _loaderChannelSetupBbMMOyz.n)({ registration: runtimeRegistration });
            ...
            if (runtimePluginRegistration.plugin) {
              ...
              mergedSetupRegistration = {
                ...setupRegistration,
                plugin: (0, _loaderChannelSetupBbMMOyz.r)(runtimePluginRegistration.plugin, setupRegistration.plugin),
      ...
      const previousAgentHarnesses = (0, _registryBzhk9nmO.a)();
      ...
      const previousMemoryCapability = (0, _memoryStateCVl5QzvG.i)();
      const previousMemoryEmbeddingProviders = (0, _memoryEmbeddingProvidersCB8LiTKl.a)();
      const previousMemoryCorpusSupplements = (0, _memoryStateCVl5QzvG.u)();
      const previousMemoryPromptSupplements = (0, _memoryStateCVl5QzvG.d)();
      ...
      try {
        ...
        if (!shouldActivate) {
          (0, _registryBzhk9nmO.c)(previousAgentHarnesses);
    ...
    if (cacheEnabled) setCachedPluginRegistry(cacheKey, {
      commands: (0, _typesBaOU_7l.k)(),
      detachedTaskRuntimeRegistration: (0, _detachedTaskRuntimeStateBfGUlR6z.n)(),
      interactiveHandlers: (0, _typesBaOU_7l.v)(),
      memoryCapability: (0, _memoryStateCVl5QzvG.i)(),
      memoryCorpusSupplements: (0, _memoryStateCVl5QzvG.u)(),
      registry,
      agentHarnesses: (0, _registryBzhk9nmO.a)(),
      compactionProviders: listRegisteredCompactionProviders(),
      memoryEmbeddingProviders: (0, _memoryEmbeddingProvidersCB8LiTKl.a)(),
      memoryPromptSupplements: (0, _memoryStateCVl5QzvG.d)()
    }, onlyPluginIds);
...
async function loadOpenClawPluginCliRegistry(options = {}) {
  ...
  const discovery = (0, _discoveryBNk7kgJV.t)({
    workspaceDir: options.workspaceDir,
    extraPaths: normalized.loadPaths,
    env,
    installRecords
  });
  const manifestRegistry = (0, _manifestRegistryCFqIGq5y.t)({
    config: cfg,
    workspaceDir: options.workspaceDir,
    env,
    candidates: discovery.candidates,
