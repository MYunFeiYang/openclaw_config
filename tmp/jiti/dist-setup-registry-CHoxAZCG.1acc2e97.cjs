...
var _configContractsQ3NUWiKS = require("./config-contracts-q3NUWiKS.js");
...
const CURRENT_MODULE_PATH = (0, _nodeUrl.fileURLToPath)("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/setup-registry-CHoxAZCG.js");
...
function getModuleLoader(modulePath) {
  return (0, _pluginModuleLoaderCacheAuBzBauz.n)({
    cache: moduleLoaders,
    modulePath,
    importerUrl: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/setup-registry-CHoxAZCG.js",
...
function resolveRelevantSetupMigrationPluginIds(params) {
  ...
  for (const plugin of registry.plugins) {
    ...
    if (paths.some((pathPattern) => (0, _configContractsQ3NUWiKS.t)({
      root: params.config,
      pathPattern
