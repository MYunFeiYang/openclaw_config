"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = withTrustedEnvProxyGuardedFetchMode;exports.i = withStrictGuardedFetchMode;exports.n = fetchWithSsrFGuard;exports.o = withTrustedExplicitProxyGuardedFetchMode;exports.r = retainSafeHeadersForCrossOriginRedirectHeaders;exports.t = void 0;var _loggerBGaqbYrv = require("./logger-BGaqbYrv.js");
var _proxyEnvDPHGz7yn = require("./proxy-env-DPHGz7yn.js");
var _undiciRuntime8SDq9eZh = require("./undici-runtime-8SDq9eZh.js");
var _undiciGlobalDispatcherB4kPHBym = require("./undici-global-dispatcher-B4kPHBym.js");
var _fetchHeadersBBx0ZA3V = require("./fetch-headers-BBx0ZA3V.js");
var _redirectHeadersBptCkJ = require("./redirect-headers-BptCk--j.js");
var _ssrfC5hZu3Z = require("./ssrf-C5hZu3Z5.js");
var _fetchTimeoutBUAEM0Ff = require("./fetch-timeout-BUAEM0Ff.js");
var _runtimeFetchBrSKxn5e = require("./runtime-fetch-BrSKxn5e.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
//#region src/infra/net/fetch-guard.ts
function resolveDispatcherTimeoutMs(fromParams) {
  if (fromParams !== void 0) return fromParams;
  if (_undiciGlobalDispatcherB4kPHBym.n !== void 0) return _undiciGlobalDispatcherB4kPHBym.n;
}
...
async function assertExplicitProxyAllowed(dispatcherPolicy, lookupFn, policy) {
  ...
  await (0, _ssrfC5hZu3Z._)(parsedProxyUrl.hostname, {
    lookupFn,
    policy: proxyPolicy
  });
}
...
function retainSafeHeadersForCrossOriginRedirectHeaders(headers) {
  return (0, _redirectHeadersBptCkJ.t)(headers);
}
async function captureGuardedFetchExchange(params) {
  ...
  const { captureHttpExchange } = await Promise.resolve().then(() => jitiImport("./runtime-DgyTSxwJ.js").then((m) => _interopRequireWildcard(m)));
  captureHttpExchange({
    url: params.url,
...
function retainSafeHeadersForCrossOriginRedirect(init) {
  ...
  return {
    ...init,
    headers: (0, _redirectHeadersBptCkJ.t)(init.headers)
  };
}
function dropBodyHeaders(headers) {
  if (!headers) return headers;
  const nextHeaders = new Headers((0, _fetchHeadersBBx0ZA3V.t)(headers));
...
async function fetchWithSsrFGuard(params) {
  ...
  const isUsingMockedFetch = (0, _runtimeFetchBrSKxn5e.r)(defaultFetch);
  ...
  const { signal, cleanup, refresh } = (0, _fetchTimeoutBUAEM0Ff.n)({
  ...
  const release = async (dispatcher) => {
    ...
    released = true;
    cleanup();
    await (0, _ssrfC5hZu3Z.i)(dispatcher ?? void 0);
  };
  const visited = new Set([params.url]);
  let currentUrl = params.url;
  let currentInit = (0, _fetchHeadersBBx0ZA3V.n)(params.init ? { ...params.init } : void 0);
  let redirectCount = 0;
  while (true) {
    let parsedUrl;
    try {
    ...
    let dispatcher = null;
    const policyForUrl = (0, _ssrfC5hZu3Z.v)(parsedUrl, params.policy);
    try {
      ...
      if (params.pinDns === false) {
        ...
        dispatcher = createPolicyDispatcherWithoutPinnedDns(params.dispatcherPolicy, timeoutMs);
      } else dispatcher = (0, _ssrfC5hZu3Z.a)(await (0, _ssrfC5hZu3Z._)(parsedUrl.hostname, {
        lookupFn: params.lookupFn,
        policy: policyForUrl
      ...
      const response = Boolean(dispatcher) && !supportsDispatcherInit ? await (0, _runtimeFetchBrSKxn5e.t)(parsedUrl.toString(), init) : await defaultFetch(parsedUrl.toString(), init);
      ...
      if (isRedirectStatus(response.status)) {
        ...
        await (0, _ssrfC5hZu3Z.i)(dispatcher);
        currentUrl = nextUrl;
        continue;
      }
      return {
      ...
      if (err instanceof _ssrfC5hZu3Z.t) (0, _loggerBGaqbYrv.a)(`security: blocked URL fetch (${params.auditContext ?? "url-fetch"}) targetOrigin=${parsedUrl.origin} reason=${err.message}`);
      await release(dispatcher);
      throw err;
    }
  }
}
//#endregion /* v9-ed546d194f7bdfd6 */
