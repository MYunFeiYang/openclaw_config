...
async function getLog() {
  if (!log) {
    logPromise ??= Promise.resolve().then(() => jitiImport("./subsystem-774Nr1UH.js").then((m) => _interopRequireWildcard(m))).then(({ createSubsystemLogger }) => createSubsystemLogger("env"));
