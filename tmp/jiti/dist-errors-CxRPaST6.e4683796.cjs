"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = toAcpRuntimeError;exports.i = isAcpRuntimeError;exports.n = void 0;exports.o = withAcpRuntimeErrorBoundary;exports.r = formatAcpErrorChain;exports.t = void 0;var _redactCxqQQvmK = require("./redact-CxqQQvmK.js");
...
function readAcpRequestErrorDetails(value) {
  ...
  const rendered = (0, _redactCxqQQvmK.s)((0, _errorsIxwfrboQ.l)(details)).trim();
...
function formatAcpErrorChain(error) {
  if (!(error instanceof Error)) return (0, _redactCxqQQvmK.s)(String(error));
  ...
  while (current !== void 0 && current !== null && depth < 8) {
    if (current instanceof Error) {
      ...
      segments.push((0, _errorsIxwfrboQ.l)(current));
      current = void 0;
    }
    depth += 1;
  }
  return (0, _redactCxqQQvmK.s)(segments.join(" <- "));
}
