...
async function assertHttpUrlTargetsPrivateNetwork(url, params = {}) {
  ...
  if ((0, _ssrfC5hZu3Z.c)(hostname)) return;
  ...
  if (!(await (0, _ssrfC5hZu3Z._)(hostname, {
    lookupFn: params.lookupFn,
    policy: ssrfPolicyFromDangerouslyAllowPrivateNetwork(true)
  })).addresses.every((address) => (0, _ssrfC5hZu3Z.u)(address))) throw new Error(errorMessage);
}
