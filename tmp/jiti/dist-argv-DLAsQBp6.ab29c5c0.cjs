...
function normalizeRuntimeBasename(execPath) {
  ...
  return (0, _stringCoerceBje8XVt.a)(lastSlash === -1 ? trimmed : trimmed.slice(lastSlash + 1));
}
...
function sanitizeCommandDescriptorDescription(description) {
  return (0, _ansiDqm1lzVL.t)(description).trim();
}
...
function resolvePrivateQaSourceModuleSpecifier(params) {
  ...
  const packageRoot = (params?.resolvePackageRootSync ?? _openclawRootCRSCIPqz.n)({
    argv1: params?.argv1 ?? process.argv[1],
    cwd: params?.cwd ?? process.cwd(),
    moduleUrl: params?.moduleUrl ?? "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/argv-DLAsQBp6.js"
  });
