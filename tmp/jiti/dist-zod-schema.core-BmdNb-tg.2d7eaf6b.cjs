...
var _execSafetyCjE6LosB = require("./exec-safety-CjE6LosB.js");
...
(0, _schemasBmna8ihM.Tn)({
  source: (0, _schemasBmna8ihM.dn)("exec"),
  command: (0, _schemasBmna8ihM.Rn)().min(1).refine((value) => (0, _execSafetyCjE6LosB.t)(value), "secrets.providers.*.command is unsafe.").refine((value) => isAbsolutePath(value), "secrets.providers.*.command must be an absolute path."),
...
const ConfiguredProviderRequestTlsSchema = (0, _schemasBmna8ihM.Tn)({
  ca: SecretInputSchema.optional().register(_zodSchemaSensitiveCoJ4c6Os.t),
  cert: SecretInputSchema.optional().register(_zodSchemaSensitiveCoJ4c6Os.t),
  key: SecretInputSchema.optional().register(_zodSchemaSensitiveCoJ4c6Os.t),
  passphrase: SecretInputSchema.optional().register(_zodSchemaSensitiveCoJ4c6Os.t),
...
(0, _schemasBmna8ihM.Tn)({
  ...
  token: SecretInputSchema.register(_zodSchemaSensitiveCoJ4c6Os.t)
}).strict(),
(0, _schemasBmna8ihM.Tn)({
  mode: (0, _schemasBmna8ihM.dn)("header"),
  headerName: (0, _schemasBmna8ihM.Rn)().min(1),
  value: SecretInputSchema.register(_zodSchemaSensitiveCoJ4c6Os.t),
...
const ConfiguredProviderRequestFields = {
  headers: (0, _schemasBmna8ihM.Nn)((0, _schemasBmna8ihM.Rn)(), SecretInputSchema.register(_zodSchemaSensitiveCoJ4c6Os.t)).optional(),
...
const ModelProviderLocalServiceSchema = (0, _schemasBmna8ihM.Tn)({
  ...
  env: (0, _schemasBmna8ihM.Nn)((0, _schemasBmna8ihM.Rn)(), (0, _schemasBmna8ihM.Rn)().register(_zodSchemaSensitiveCoJ4c6Os.t)).optional(),
...
const ModelProviderSchema = (0, _schemasBmna8ihM.Tn)({
  baseUrl: (0, _schemasBmna8ihM.Rn)().min(1),
  apiKey: SecretInputSchema.optional().register(_zodSchemaSensitiveCoJ4c6Os.t),
  ...
  models: (0, _schemasBmna8ihM.Et)(ModelDefinitionSchema)
}).strict();
...
const ModelsConfigSchema = exports.g = (0, _schemasBmna8ihM.Tn)({
  ...
  providers: (0, _schemasBmna8ihM.Nn)((0, _schemasBmna8ihM.Rn)(), ModelProviderSchema).optional(),
...
const TtsProviderConfigSchema = (0, _schemasBmna8ihM.Tn)({ apiKey: SecretInputSchema.optional().register(_zodSchemaSensitiveCoJ4c6Os.t) }).catchall((0, _schemasBmna8ihM.Xn)([
...
const TranscribeAudioSchema = exports.k = (0, _schemasBmna8ihM.Tn)({
  command: (0, _schemasBmna8ihM.Et)((0, _schemasBmna8ihM.Rn)()).superRefine((value, ctx) => {
    ...
    if (!(0, _execSafetyCjE6LosB.t)(executable)) ctx.addIssue({
      code: _compatZe2wFLca.n.custom,
      path: [0],
...
const ExecutableTokenSchema = exports.s = (0, _schemasBmna8ihM.Rn)().refine(_execSafetyCjE6LosB.t, "expected safe executable name or path");
