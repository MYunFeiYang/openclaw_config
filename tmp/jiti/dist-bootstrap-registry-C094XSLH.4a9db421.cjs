...
function listBundledChannelIdsForRoot(_packageRoot, env = process.env) {
  return (0, _channelCatalogRegistryDB8mFwRi.t)({
    origin: "bundled",
    env
...
function listBundledChannelIds(env = process.env) {
  return listBundledChannelIdsForRoot((0, _bundledDowL9sGd.m)(env).cacheKey, env);
}
//#endregion
...
function getBootstrapChannelPlugin(id) {
  ...
  let setupPlugin;
  try {
    runtimePlugin = (0, _bundledDowL9sGd.n)(resolvedId);
    setupPlugin = (0, _bundledDowL9sGd.i)(resolvedId);
  } catch {
    return;
  }
...
function getBootstrapChannelSecrets(id) {
  ...
  if (!resolvedId) return;
  try {
    return mergePluginSection((0, _bundledDowL9sGd.r)(resolvedId), (0, _bundledDowL9sGd.a)(resolvedId));
  } catch {
    return;
  }
}
//#endregion /* v9-02f46b7757637e0c */
