"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = shouldUseSyntheticOllamaAuth;exports.n = void 0;exports.r = resolveOllamaDiscoveryResult;exports.t = void 0;var _providerCatalogSharedCD80ANYK = require("./provider-catalog-shared-CD80ANYK.js");
var _defaultsD73PVc6P = require("./defaults-D73PVc6P.js");
var _providerBaseUrlW75mLU = require("./provider-base-url-W75mL-u6.js");
...
function hasExplicitRemoteOllamaApiProvider(providers) {
  ...
  for (const [providerId, provider] of Object.entries(providers)) {
    ...
    const baseUrl = (0, _providerBaseUrlW75mLU.t)(provider);
...
function shouldUseSyntheticOllamaAuth(providerConfig) {
  ...
  return isLocalOllamaBaseUrl((0, _providerBaseUrlW75mLU.t)(providerConfig));
}
function hasMeaningfulExplicitOllamaConfig(providerConfig) {
  ...
  const baseUrl = (0, _providerBaseUrlW75mLU.t)(providerConfig);
  if (baseUrl) return (0, _providerBaseUrlW75mLU.u)(baseUrl) !== _defaultsD73PVc6P.n;
...
async function resolveOllamaDiscoveryResult(params) {
  ...
  if (hasExplicitModels && explicit) {
    const baseUrl = (0, _providerBaseUrlW75mLU.u)((0, _providerBaseUrlW75mLU.t)(explicit) ?? "http://127.0.0.1:11434");
  ...
  const configuredBaseUrl = (0, _providerBaseUrlW75mLU.t)(explicit);
  const quiet = !hasRealOllamaKey && !hasMeaningfulExplicitConfig;
  const provider = await (0, _providerCatalogSharedCD80ANYK.i)({
    keyParts: [
    OLLAMA_PROVIDER_ID,
    "models",
