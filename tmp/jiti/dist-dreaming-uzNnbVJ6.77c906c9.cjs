...
function resolveMemoryDreamingWorkspaces(cfg, options = {}) {
  ...
  if (agentIds.length === 0) agentIds.push((0, _agentScopeConfigDUwbsKjv.c)(cfg));
  const byWorkspace = /* @__PURE__ */new Map();
  const addWorkspace = (workspaceDirRaw, agentIdRaw) => {
    const workspaceDir = workspaceDirRaw?.trim();
    if (!workspaceDir) return;
    const agentId = (0, _stringCoerceLndEvhRk.s)(agentIdRaw) || (0, _agentScopeConfigDUwbsKjv.c)(cfg);
  ...
  for (const agentId of agentIds) addWorkspace((0, _agentScopeConfigDUwbsKjv.o)(cfg, agentId), agentId);
  addWorkspace(options.primaryWorkspaceDir ?? void 0, options.primaryAgentId ?? (0, _agentScopeConfigDUwbsKjv.c)(cfg));
  return [...byWorkspace.values()];
}
//#endregion /* v9-f681662b3ef28b19 */
