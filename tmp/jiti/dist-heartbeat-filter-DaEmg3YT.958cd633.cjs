"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = isHeartbeatOkResponse;exports.r = isHeartbeatUserMessage;exports.t = filterHeartbeatPairs;var _heartbeatCxHCYc7v = require("./heartbeat-CxHCYc7v.js");
...
function isHeartbeatOkResponse(message, ackMaxChars) {
  ...
  return (0, _heartbeatCxHCYc7v.c)(text, {
    mode: "heartbeat",
