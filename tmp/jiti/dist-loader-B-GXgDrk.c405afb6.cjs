"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.C = listRegisteredAgentHarnesses;exports.S = disposeRegisteredAgentHarnesses;exports._ = projectPluginSessionExtensionsSync;exports.a = clearPluginRegistryLoadCache;exports.b = getCompactionProvider;exports.c = loadOpenClawPluginCliRegistry;exports.d = resolvePluginRegistryLoadCacheKey;exports.f = resolveRuntimePluginRegistry;exports.g = patchPluginSessionExtension;exports.h = getPluginSessionExtensionStateSync;exports.i = clearPluginLoaderCache;exports.l = loadOpenClawPlugins;exports.m = drainPluginNextTurnInjectionContext;exports.n = void 0;exports.o = getRuntimePluginRegistryForLoadOptions;exports.p = createPluginRegistry;exports.r = clearActivatedPluginRuntimeState;exports.s = isPluginRegistryLoadInFlight;exports.t = void 0;exports.u = resolveCompatibleRuntimePluginRegistry;exports.v = listCodexAppServerExtensionFactories;exports.w = resetRegisteredAgentHarnessSessions;exports.x = resolvePluginActivationSourceConfig;exports.y = void 0;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
var _argvDLAsQBp = require("./argv-DLAsQBp6.js");
...
require("./installed-plugin-index-records-CVO2sce8.js");
var _runtimeSnapshotDFDX1J4B = require("./runtime-snapshot-DFDX1J4B.js");
var _schemaValidatorDSVrkbYC = require("./schema-validator-DSVrkbYC.js");
var _chatMetaDIlVJJ5G = require("./chat-meta-DIlVJJ5G.js");
var _gatewayMethodPolicyDCpp7ZHJ = require("./gateway-method-policy-DCpp7ZHJ.js");
var _operatorScopesD9nPeeKf = require("./operator-scopes-D9nPeeKf.js");
...
var _apiBuilderNgUrqxn = require("./api-builder-ngUrqxn2.js");
var _dreamingOOlVey8D = require("./dreaming-oOlVey8D.js");
var _detachedTaskRuntimeStateDyzZsL3h = require("./detached-task-runtime-state-DyzZsL3h.js");
var _bundleMcpDPPOalPH = require("./bundle-mcp-DPPOalPH.js");
var _typesCdFhLeaX = require("./types-CdFhLeaX.js");
var _hookRunnerGlobalCCAcWVdN = require("./hook-runner-global-CCAcWVdN.js");
var _loaderChannelSetupCHB0cfUp = require("./loader-channel-setup-CHB0cfUp.js");
var _memoryEmbeddingProviders3vy8Xe8H = require("./memory-embedding-providers-3vy8Xe8H.js");
var _memoryStateDKt50i_K = require("./memory-state-DKt50i_K.js");
var _pluginLoadProfileCX9TjsiD = require("./plugin-load-profile-CX9TjsiD.js");
var _runtimeB0MMVyKh = require("./runtime-B0MMVyKh.js");
var _registryCxcGD4Pv = require("./registry-CxcGD4Pv.js");
var _internalHooksC9TbPRWK = require("./internal-hooks-C9TbPRWK.js");
var _nodeCommandsBuCDzMPx = require("./node-commands-BuCDzMPx.js");
var _pluginStateStoreB1vkXITa = require("./plugin-state-store-B1vkXITa.js");
var _toolContractsDxWKDI1k = require("./tool-contracts-DxWKDI1k.js");
...
require("./sessions-DEgkNCWw.js");
var _hostHookCleanupAnLVP8hm = require("./host-hook-cleanup-AnLVP8hm.js");
var _httpRouteOverlapBS8Pb5Rv = require("./http-route-overlap-BS8Pb5Rv.js");
var _gatewayRequestScopeBhLQLn2S = require("./gateway-request-scope-BhLQLn2S.js");
...
const log$1 = (0, _subsystemCxWoQXRD.t)("agents/harness");
...
function resolvePluginActivationSourceConfig(params) {
  ...
  const sourceSnapshot = (0, _runtimeSnapshotDFDX1J4B.s)();
  if (sourceSnapshot && params.config === (0, _runtimeSnapshotDFDX1J4B.i)()) return sourceSnapshot;
...
};exports.y = PluginLoadReentryError;
var PluginLoaderCacheState = class {
  ...
  constructor(defaultMaxEntries) {
    this.#registryCache = new _pluginCachePrimitivesWfwcOrBF.t(defaultMaxEntries);
  }
  get maxEntries() {
...
function addPathToMatcher(matcher, rawPath, env = process.env) {
  ...
  if (!trimmed) return;
  const resolved = (0, _utilsD5swhEXt.p)(trimmed, env);
  if (!resolved) return;
  const canonical = (0, _discoveryCVL9KJt.f)(resolved) ?? resolved;
  if (matcher.exact.has(canonical) || matcher.dirs.includes(canonical)) return;
  if ((0, _discoveryCVL9KJt.p)(canonical)?.isDirectory()) {
...
function matchesPathMatcher(matcher, sourcePath) {
  ...
  return matcher.dirs.some((dirPath) => (0, _discoveryCVL9KJt.d)(dirPath, sourcePath));
}
function buildProvenanceIndex(params) {
  ...
  const installs = (0, _manifestRegistryBiAsJcRZ.s)({ env: params.env });
  for (const [pluginId, install] of Object.entries(installs)) {
    const rule = {
      trackedWithoutPaths: false,
      matcher: createPathMatcher()
    };
    const trackedPaths = [install.installPath, install.sourcePath].map((entry) => (0, _stringCoerceBje8XVt.c)(entry)).filter((entry) => Boolean(entry));
...
function isTrackedByProvenance(params) {
  const sourcePath = (0, _utilsD5swhEXt.p)(params.source, params.env);
  const canonicalSourcePath = (0, _discoveryCVL9KJt.f)(sourcePath) ?? sourcePath;
...
function isPluginLoadDebugEnabled(env) {
  const normalized = (0, _stringCoerceBje8XVt.a)(env.OPENCLAW_PLUGIN_LOAD_DEBUG);
...
function resolveBundledChannelMeta(id) {
  return (0, _chatMetaDIlVJJ5G.n)().find((meta) => meta?.id === id);
}
function collectMissingChannelMetaFields(meta) {
  const missing = [];
  if (!(0, _stringCoerceBje8XVt.c)(meta?.label)) missing.push("label");
  if (!(0, _stringCoerceBje8XVt.c)(meta?.selectionLabel)) missing.push("selectionLabel");
  if (!(0, _stringCoerceBje8XVt.c)(meta?.docsPath)) missing.push("docsPath");
  if (typeof meta?.blurb !== "string") missing.push("blurb");
  return missing;
}
function normalizeRegisteredChannelPlugin(params) {
  const id = (0, _stringCoerceBje8XVt.c)(params.plugin?.id) ?? (0, _stringCoerceBje8XVt.d)(params.plugin?.id) ?? "";
  if (!id) {
  ...
  const rawMetaId = (0, _stringCoerceBje8XVt.c)(rawMeta?.id);
...
function listCodexAppServerExtensionFactories() {
  return (0, _runtimeB0MMVyKh.a)()?.codexAppServerExtensionFactories?.map((entry) => entry.factory) ?? [];
}
//#endregion
//#region src/plugins/host-hook-state.ts
const log = (0, _subsystemCxWoQXRD.t)("plugins/host-hook-state");
...
function findStoreKeysIgnoreCase(store, targetKey) {
  const lowered = (0, _stringCoerceBje8XVt.a)(targetKey);
  const matches = [];
  for (const key of Object.keys(store)) if ((0, _stringCoerceBje8XVt.a)(key) === lowered) matches.push(key);
  return matches;
}
function findFreshestStoreMatch(store, ...candidates) {
  let freshest;
  for (const candidate of candidates) {
    const trimmed = (0, _stringCoerceBje8XVt.c)(candidate) ?? "";
    if (!trimmed) continue;
...
function resolveSessionStoreCandidates(params) {
  ...
  const defaultTarget = {
    ...
    storePath: (0, _pathsDG09LEN.d)(storeConfig, { agentId: params.agentId })
  };
  if (!isStorePathTemplate(storeConfig)) return [defaultTarget];
  const targets = /* @__PURE__ */new Map();
  targets.set(defaultTarget.storePath, defaultTarget);
  for (const target of (0, _targetsDjI6H8v.r)(params.cfg)) if (target.agentId === params.agentId) targets.set(target.storePath, target);
...
function buildSessionStoreScanTargets(params) {
  ...
  const agentMainKey = (0, _mainSessionC7L7pyed.n)({
    cfg: params.cfg,
    agentId: params.agentId
  });
...
function loadPluginHostHookSessionEntry(params) {
  const key = (0, _stringCoerceBje8XVt.c)(params.sessionKey) ?? "";
  const cfg = params.cfg;
  const canonicalKey = (0, _combinedStoreGatewayD10iqlpI.a)({
    cfg,
    sessionKey: key
  });
  const agentId = (0, _combinedStoreGatewayD10iqlpI.i)(cfg, canonicalKey);
  ...
  const fallback = candidates[0] ?? {
    agentId,
    storePath: (0, _pathsDG09LEN.d)(cfg.session?.store, { agentId })
  };
  let selectedStorePath = fallback.storePath;
  let selectedMatch = findFreshestStoreMatch((0, _storeLoadDjtlQRVG.t)(fallback.storePath), ...scanTargets);
  for (let index = 1; index < candidates.length; index += 1) {
    const candidate = candidates[index];
    if (!candidate) continue;
    const match = findFreshestStoreMatch((0, _storeLoadDjtlQRVG.t)(candidate.storePath), ...scanTargets);
...
async function enqueuePluginNextTurnInjection(params) {
  ...
  if (params.injection.metadata !== void 0 && !(0, _runtimeB0MMVyKh.M)(params.injection.metadata)) return {
    enqueued: false,
    id: "",
    sessionKey
  };
  ...
  await (0, _storeDvxAjGkI.o)(loaded.storePath, (store) => {
...
async function drainPluginNextTurnInjections(params) {
  ...
  const now = params.now ?? Date.now();
  return await (0, _storeDvxAjGkI.o)(loaded.storePath, (store) => {
    const entry = store[loaded.storeKey];
    if (!entry?.pluginNextTurnInjections) return [];
    const activePluginIds = new Set(((0, _runtimeB0MMVyKh.a)()?.plugins ?? []).filter((plugin) => plugin.status === "loaded").map((plugin) => plugin.id));
    const drained = [];
...
async function drainPluginNextTurnInjectionContext(params) {
  ...
  return {
    queuedInjections,
    ...(0, _runtimeB0MMVyKh.A)({ queuedInjections })
  };
}
function getPluginSessionExtensionStateSync(params) {
  const pluginId = params.pluginId.trim();
  const sessionKey = (0, _stringCoerceBje8XVt.c)(params.sessionKey);
...
async function patchPluginSessionExtension(params) {
  ...
  if (params.value !== void 0 && !(0, _runtimeB0MMVyKh.M)(params.value)) return {
    ok: false,
  ...
  const registration = ((0, _runtimeB0MMVyKh.a)()?.sessionExtensions ?? []).find((entry) => entry.pluginId === pluginId && entry.extension.namespace === namespace);
  ...
  const rawSlotKey = (0, _stringCoerceBje8XVt.c)(registration.extension.sessionEntrySlotKey);
  const normalizedSlotKey = rawSlotKey ? (0, _hostHookCleanupAnLVP8hm.i)(rawSlotKey) : void 0;
  ...
  return {
    ok: true,
    key: canonicalKey,
    value: await (0, _storeDvxAjGkI.o)(loaded.storePath, (store) => {
      const entry = store[loaded.storeKey];
      if (!entry) return;
      ...
      const previousSlotKey = (0, _hostHookCleanupAnLVP8hm.i)(pluginSlotKeys[namespace]);
...
function projectSessionExtensionValueForSlot(params) {
  ...
  if (projected === void 0 || !(0, _runtimeB0MMVyKh.M)(projected)) return;
...
function projectPluginSessionExtensionsSync(params) {
  const extensions = (0, _runtimeB0MMVyKh.a)()?.sessionExtensions ?? [];
  ...
  for (const registration of extensions) {
    ...
    if (projected === void 0 || !(0, _runtimeB0MMVyKh.M)(projected)) continue;
    projections.push({
      pluginId: registration.pluginId,
      namespace: registration.extension.namespace,
...
function normalizeTextList(values) {
  const normalized = Array.from(new Set((0, _stringNormalizationC5SGsaST.l)(values)));
...
function normalizeProviderOAuthProfileIdRepairs(values) {
  ...
  const normalized = values.map((value) => {
    const legacyProfileId = (0, _stringCoerceBje8XVt.c)(value?.legacyProfileId);
    const promptLabel = (0, _stringCoerceBje8XVt.c)(value?.promptLabel);
...
function buildNormalizedModelAllowlist(modelAllowlist) {
  ...
  const message = (0, _stringCoerceBje8XVt.c)(modelAllowlist.message);
...
function buildNormalizedWizardSetup(params) {
  const choiceId = (0, _stringCoerceBje8XVt.c)(params.setup.choiceId);
  const choiceLabel = (0, _stringCoerceBje8XVt.c)(params.setup.choiceLabel);
  const choiceHint = (0, _stringCoerceBje8XVt.c)(params.setup.choiceHint);
  const groupId = (0, _stringCoerceBje8XVt.c)(params.setup.groupId);
  const groupLabel = (0, _stringCoerceBje8XVt.c)(params.setup.groupLabel);
  const groupHint = (0, _stringCoerceBje8XVt.c)(params.setup.groupHint);
...
function buildNormalizedModelPicker(modelPicker, methodId) {
  const label = (0, _stringCoerceBje8XVt.c)(modelPicker.label);
  const hint = (0, _stringCoerceBje8XVt.c)(modelPicker.hint);
  return {
    ...(label ? { label } : {}),
    ...(hint ? { hint } : {}),
    ...(methodId ? { methodId } : {})
...
function normalizeProviderWizardSetup(params) {
  ...
  const methodId = resolveWizardMethodId({
    ...
    source: params.source,
    auth: params.auth,
    methodId: (0, _stringCoerceBje8XVt.c)(params.setup.methodId),
    metadataKind: "setup",
    pushDiagnostic: params.pushDiagnostic
  });
...
function normalizeProviderAuthMethods(params) {
  ...
  for (const method of params.auth) {
    const methodId = (0, _stringCoerceBje8XVt.c)(method.id);
    if (!methodId) {
      pushPluginValidationDiagnostic({
        level: "error",
        pluginId: params.pluginId,
    ...
    normalized.push({
      ...method,
      id: methodId,
      label: (0, _stringCoerceBje8XVt.c)(method.label) ?? methodId,
      ...((0, _stringCoerceBje8XVt.c)(method.hint) ? { hint: (0, _stringCoerceBje8XVt.c)(method.hint) } : {}),
      ...(wizard ? { wizard } : {})
    });
  }
  return normalized;
...
function normalizeProviderWizard(params) {
  ...
  const normalizeModelPicker = () => {
    ...
    return buildNormalizedModelPicker(modelPicker, resolveWizardMethodId({
      ...
      source: params.source,
      auth: params.auth,
      methodId: (0, _stringCoerceBje8XVt.c)(modelPicker.methodId),
...
function normalizeRegisteredProvider(params) {
  const id = (0, _stringCoerceBje8XVt.c)(params.provider.id);
  if (!id) {
    pushPluginValidationDiagnostic({
      level: "error",
      pluginId: params.pluginId,
  ...
  const docsPath = (0, _stringCoerceBje8XVt.c)(params.provider.docsPath);
  ...
  return {
    ...restProvider,
    id,
    label: (0, _stringCoerceBje8XVt.c)(params.provider.label) ?? id,
    ...(docsPath ? { docsPath } : {}),
    ...(aliases ? { aliases } : {}),
...
const constrainLegacyPromptInjectionHook = (handler) => {
  return (event, ctx) => {
    ...
    if (result && typeof result === "object" && "then" in result) return Promise.resolve(result).then((resolved) => (0, _typesCdFhLeaX.l)(resolved));
    return (0, _typesCdFhLeaX.l)(result);
  };
};
function resolvePluginPath(input, rootDir) {
  const trimmed = input.trim();
  if (!trimmed || _nodePath.default.isAbsolute(trimmed) || trimmed.startsWith("~")) return (0, _utilsD5swhEXt.p)(input);
  return rootDir ? _nodePath.default.resolve(rootDir, trimmed) : (0, _utilsD5swhEXt.p)(input);
}
...
const activePluginHookRegistrations = (0, _globalSingletonDZyLAEQq.n)(Symbol.for("openclaw.activePluginHookRegistrations"), () => /* @__PURE__ */new Map());
/**
...
function createPluginRegistry(registryParams) {
  const registry = (0, _runtimeB0MMVyKh.P)();
  ...
  const registerAgentToolResultMiddleware = (record, handler, options) => {
    ...
    const runtimes = (0, _toolContractsDxWKDI1k.o)(options);
    ...
    const declared = (0, _toolContractsDxWKDI1k.a)(record.contracts?.agentToolResultMiddleware);
  ...
  const registerTool = (record, tool, opts) => {
    ...
    const declaredNames = (0, _toolContractsDxWKDI1k.n)(record.contracts);
    ...
    const normalized = (0, _toolContractsDxWKDI1k.r)(names);
    const undeclared = (0, _toolContractsDxWKDI1k.t)({
      declaredNames,
  ...
  const registerHook = (record, events, handler, opts, config, pluginConfig) => {
    ...
    for (const registration of previousRegistrations) (0, _internalHooksC9TbPRWK.h)(registration.event, registration.handler);
    ...
    for (const event of normalizedEvents) {
      ...
      (0, _internalHooksC9TbPRWK.f)(event, wrappedHandler);
  ...
  const registerGatewayMethod = (record, method, handler, opts) => {
    ...
    const normalizedScope = (0, _gatewayMethodPolicyDCpp7ZHJ.t)(trimmed, opts?.scope);
  ...
  const describeHttpRouteOwner = (entry) => {
    return `${(0, _stringCoerceBje8XVt.c)(entry.pluginId) || "unknown-plugin"} (${(0, _stringCoerceBje8XVt.c)(entry.source) || "unknown-source"})`;
  };
  const registerHttpRoute = (record, params) => {
    const normalizedPath = (0, _httpRouteOverlapBS8Pb5Rv.n)(params.path);
    if (!normalizedPath) {
      pushDiagnostic({
        level: "warn",
        pluginId: record.id,
    ...
    const overlappingRoute = (0, _httpRouteOverlapBS8Pb5Rv.t)(registry.httpRoutes, {
      path: normalizedPath,
      match
    });
  ...
  const registerAgentHarness$1 = (record, harness) => {
    const id = (0, _stringCoerceBje8XVt.c)(harness?.id) ?? "";
    if (!id) {
      pushDiagnostic({
        level: "error",
        pluginId: record.id,
  ...
  const registerCli = (record, registrar, opts) => {
    const normalizeCommandRoot = (raw, source) => {
      const normalized = (0, _argvDLAsQBp.S)(raw);
    ...
    const descriptors = (opts?.descriptors ?? []).map((descriptor) => {
      ...
      const description = (0, _argvDLAsQBp.C)(descriptor.description);
  ...
  ..._nodeCommandsBuCDzMPx.i,
  ..._nodeCommandsBuCDzMPx.n,
  _nodeCommandsBuCDzMPx.r]
  );
  ...
  const registerNodeHostCommand = (record, nodeCommand) => {
    ...
    registry.nodeHostCommands.push({
      ...
      command: {
        ...nodeCommand,
        command,
        cap: (0, _stringCoerceBje8XVt.c)(nodeCommand.cap)
      },
      source: record.source,
      rootDir: record.rootDir
    });
  ...
  const registerCommand = (record, command) => {
    ...
    if (allowReservedCommandNames && !(0, _typesCdFhLeaX.u)(name)) {
      pushDiagnostic({
        level: "error",
        pluginId: record.id,
        source: record.source,
    ...
    if (allowReservedCommandNames && record.id !== (0, _stringCoerceBje8XVt.a)(name)) {
      pushDiagnostic({
        level: "error",
        pluginId: record.id,
        source: record.source,
        message: `command registration failed: Reserved command ownership requires plugin id "${record.id}" to match reserved command name "${(0, _stringCoerceBje8XVt.a)(name)}"`
      });
      return;
    }
    if (!registryParams.activateGlobalSideEffects) {
      const validationError = (0, _typesCdFhLeaX.h)(command, { allowReservedCommandNames });
      if (validationError) {
        pushDiagnostic({
          level: "error",
          pluginId: record.id,
      ...
      const result = (0, _typesCdFhLeaX.p)(record.id, allowReservedCommandNames ? commandForRegistration : command, {
        pluginName: record.name,
      ...
      if (allowReservedCommandNames) {
        const registeredCommand = _typesCdFhLeaX.A.get(`/${name.toLowerCase()}`);
  ...
  const normalizeHostHookString = (value) => typeof value === "string" ? (0, _runtimeB0MMVyKh.j)(value) : "";
  ...
  const registerSessionExtension = (record, extension) => {
    ...
    if (extension.sessionEntrySlotKey !== void 0) {
      const slotKey = (0, _hostHookCleanupAnLVP8hm.i)(extension.sessionEntrySlotKey);
    ...
    if (normalizedSessionEntrySlotKey) {
      if ((registry.sessionExtensions ?? []).find((entry) => {
        ...
        const normalizedExistingSlotKey = (0, _hostHookCleanupAnLVP8hm.i)(existingSlotKey);
  ...
  const registerToolMetadata = (record, metadata) => {
    ...
    const undeclared = (0, _toolContractsDxWKDI1k.t)({
      declaredNames: (0, _toolContractsDxWKDI1k.n)(record.contracts),
      toolNames: [toolName]
    });
    if (undeclared.length > 0) {
      pushDiagnostic({
  ...
  const registerControlUiDescriptor = (record, descriptor) => {
    ...
    if (requiredScopes !== void 0) {
      const unknownScope = requiredScopes.find((scope) => !(0, _operatorScopesD9nPeeKf.s)(scope));
    ...
    if (descriptor.schema !== void 0 && !(0, _runtimeB0MMVyKh.M)(descriptor.schema)) {
      pushDiagnostic({
        level: "error",
        pluginId: record.id,
        source: record.source,
  ...
  const registerRuntimeLifecycle = (record, lifecycle) => {
    const id = (0, _runtimeB0MMVyKh.j)(lifecycle.id);
    if (!id) {
      pushDiagnostic({
        level: "error",
        pluginId: record.id,
  ...
  const registerAgentEventSubscription = (record, subscription) => {
    const id = (0, _runtimeB0MMVyKh.j)(subscription.id);
  ...
  const registerSessionSchedulerJob = (record, job) => {
    ...
    const handle = (0, _runtimeB0MMVyKh.O)({
      pluginId: record.id,
      pluginName: record.name,
      job: {
        ...job,
    ...
    (registry.sessionSchedulerJobs ??= []).push({
      ...
      generation: (0, _runtimeB0MMVyKh.E)({
        pluginId: record.id,
        jobId: handle.id,
        sessionKey: handle.sessionKey
      }),
  ...
  const registerTypedHook = (record, hookName, handler, opts, policy) => {
    if (!(0, _typesCdFhLeaX.o)(hookName)) {
      pushDiagnostic({
        level: "warn",
        pluginId: record.id,
        source: record.source,
    ...
    if (policy?.allowPromptInjection === false && (0, _typesCdFhLeaX.s)(hookName)) {
    ...
    if ((0, _typesCdFhLeaX.a)(hookName)) {
    ...
    const runtime = new Proxy(registryParams.runtime, { get(target, prop, receiver) {
        if (prop === "state") return {
          ...
          openKeyedStore: (options) => {
            ...
            return (0, _pluginStateStoreB1vkXITa.t)(pluginId, options);
          }
        };
        if (prop !== "subagent") return Reflect.get(target, prop, receiver);
        const subagent = Reflect.get(target, prop, receiver);
        return {
          run: (params) => (0, _gatewayRequestScopeBhLQLn2S.r)(pluginId, () => subagent.run(params)),
          waitForRun: (params) => (0, _gatewayRequestScopeBhLQLn2S.r)(pluginId, () => subagent.waitForRun(params)),
          getSessionMessages: (params) => (0, _gatewayRequestScopeBhLQLn2S.r)(pluginId, () => subagent.getSessionMessages(params)),
          getSession: (params) => (0, _gatewayRequestScopeBhLQLn2S.r)(pluginId, () => subagent.getSession(params)),
          deleteSession: (params) => (0, _gatewayRequestScopeBhLQLn2S.r)(pluginId, () => subagent.deleteSession(params))
        };
      } });
  ...
  const createApi = (record, params) => {
    ...
    const shouldCommitWorkflowSideEffect = () => sideEffectGuard.active && !(0, _runtimeB0MMVyKh.S)(registry) && (isLoadedRecordInRegistry() || isActivatingLoadedRecord());
    return (0, _apiBuilderNgUrqxn.t)({
      id: record.id,
      name: record.name,
      ...
      handlers: {
        ...(registrationCapabilities.capabilityHandlers ? {
          ...
          registerDetachedTaskRuntime: (runtime) => {
            const existing = (0, _detachedTaskRuntimeStateDyzZsL3h.n)();
            ...
            (0, _detachedTaskRuntimeStateDyzZsL3h.i)(record.id, runtime);
          },
          ...
          registerInteractiveHandler: (registration) => {
            const result = (0, _typesCdFhLeaX.y)(record.id, registration, {
              pluginName: record.name,
              pluginRoot: record.rootDir
            });
          ...
          registerContextEngine: (id, factory) => {
            const normalizedId = (0, _stringCoerceBje8XVt.c)(id) ?? "";
            if (!normalizedId) {
              pushDiagnostic({
                level: "error",
                pluginId: record.id,
            ...
            if (normalizedId === (0, _slotsCQkAb1S.n)("contextEngine")) {
              pushDiagnostic({
                level: "error",
                pluginId: record.id,
                source: record.source,
            ...
            const result = (0, _registryCxcGD4Pv.r)(normalizedId, factory, `plugin:${record.id}`, { allowSameOwnerRefresh: true });
            if (!result.ok) {
              pushDiagnostic({
                level: "error",
                pluginId: record.id,
          ...
          registerCompactionProvider: (provider) => {
            const id = (0, _stringCoerceBje8XVt.c)(provider?.id);
            if (!id) {
              pushDiagnostic({
                level: "error",
                pluginId: record.id,
          ...
          setRunContext: (patch) => registryParams.activateGlobalSideEffects !== false && shouldCommitWorkflowSideEffect() ? (0, _runtimeB0MMVyKh.k)({
            pluginId: record.id,
            patch
          }) : false,
          getRunContext: (get) => (0, _runtimeB0MMVyKh.T)({
            pluginId: record.id,
            get
          }),
          clearRunContext: (params) => {
            if (registryParams.activateGlobalSideEffects === false || !shouldCommitWorkflowSideEffect()) return;
            (0, _runtimeB0MMVyKh.w)({
              pluginId: record.id,
              runId: params.runId,
          ...
          registerMemoryCapability: (capability) => {
            if (!(0, _slotsCQkAb1S.r)(record.kind, "memory")) throwRegistrationError("only memory plugins can register a memory capability");
            ...
            (0, _memoryStateDKt50i_K.f)(record.id, capability);
          },
          registerMemoryPromptSection: (builder) => {
            if (!(0, _slotsCQkAb1S.r)(record.kind, "memory")) throwRegistrationError("only memory plugins can register a memory prompt section");
            if (Array.isArray(record.kind) && record.kind.length > 1 && !record.memorySlotSelected) {
              pushDiagnostic({
                level: "warn",
                pluginId: record.id,
            ...
            (0, _memoryStateDKt50i_K._)(record.id, builder);
          },
          registerMemoryPromptSupplement: (builder) => {
            ...
            (0, _memoryStateDKt50i_K.v)(record.id, builder);
          },
          registerMemoryCorpusSupplement: (supplement) => {
            (0, _memoryStateDKt50i_K.p)(record.id, supplement);
          },
          registerMemoryFlushPlan: (resolver) => {
            if (!(0, _slotsCQkAb1S.r)(record.kind, "memory")) throwRegistrationError("only memory plugins can register a memory flush plan");
            if (Array.isArray(record.kind) && record.kind.length > 1 && !record.memorySlotSelected) {
              pushDiagnostic({
                level: "warn",
                pluginId: record.id,
            ...
            (0, _memoryStateDKt50i_K.h)(record.id, resolver);
          },
          registerMemoryRuntime: (runtime) => {
            if (!(0, _slotsCQkAb1S.r)(record.kind, "memory")) throwRegistrationError("only memory plugins can register a memory runtime");
            if (Array.isArray(record.kind) && record.kind.length > 1 && !record.memorySlotSelected) {
              pushDiagnostic({
                level: "warn",
                pluginId: record.id,
            ...
            (0, _memoryStateDKt50i_K.b)(record.id, runtime);
          },
          registerMemoryEmbeddingProvider: (adapter) => {
            if ((0, _slotsCQkAb1S.r)(record.kind, "memory")) {
              if (Array.isArray(record.kind) && record.kind.length > 1 && !record.memorySlotSelected) {
                pushDiagnostic({
                  level: "warn",
                  pluginId: record.id,
            ...
            const existing = (0, _memoryEmbeddingProviders3vy8Xe8H.r)(adapter.id);
            if (existing) {
              const ownerDetail = existing.ownerPluginId ? ` (owner: ${existing.ownerPluginId})` : "";
              pushDiagnostic({
                level: "error",
            ...
            (0, _memoryEmbeddingProviders3vy8Xe8H.o)(adapter, { ownerPluginId: record.id });
  ...
  const rollbackPluginGlobalSideEffects = (pluginId) => {
    ...
    (0, _typesCdFhLeaX.E)(pluginId);
    (0, _typesCdFhLeaX._)(pluginId);
    (0, _registryCxcGD4Pv.t)(`plugin:${pluginId}`);
    ...
    for (const entry of hookRollbackEntries.toReversed()) {
      ...
      for (const registration of activeRegistrations) (0, _internalHooksC9TbPRWK.h)(registration.event, registration.handler);
      if (entry.previousRegistrations.length === 0) {
        activePluginHookRegistrations.delete(entry.name);
        continue;
      }
      for (const registration of entry.previousRegistrations) (0, _internalHooksC9TbPRWK.f)(registration.event, registration.handler);
...
function resolveDreamingSidecarEngineId(params) {
  const normalizedMemorySlot = (0, _stringCoerceBje8XVt.a)(params.memorySlot);
  if (!normalizedMemorySlot || normalizedMemorySlot === "none" || normalizedMemorySlot === "memory-core") return null;
  return (0, _dreamingOOlVey8D.G)({
    pluginConfig: (0, _dreamingOOlVey8D.K)(params.cfg),
    cfg: params.cfg
  }).enabled ? _dreamingOOlVey8D._ : null;
}
...
function clearActivatedPluginRuntimeState() {
  ...
  (0, _detachedTaskRuntimeStateDyzZsL3h.t)();
  (0, _typesCdFhLeaX.g)();
  (0, _memoryEmbeddingProviders3vy8Xe8H.t)();
  (0, _memoryStateDKt50i_K.r)();
}
...
const defaultLogger = () => (0, _subsystemCxWoQXRD.t)("plugins");
...
function createPluginModuleLoader(options) {
  ...
  const createLoaderForModule = (modulePath) => {
    return (0, _pluginModuleLoaderCacheB600Kx.n)({
      cache: moduleLoaders,
      modulePath,
      importerUrl: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/loader-B-GXgDrk.js",
      loaderFilename: modulePath,
      aliasMap: (0, _sdkAliasDiiCKlea.t)(modulePath, process.argv[1], "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/loader-B-GXgDrk.js", options.pluginSdkResolution),
      pluginSdkResolution: options.pluginSdkResolution
    });
  };
  return (modulePath) => createLoaderForModule(modulePath)((0, _pluginModuleLoaderCacheB600Kx.s)(modulePath));
}
...
const __testing = exports.n = {
  buildPluginLoaderJitiOptions: _sdkAliasDiiCKlea.n,
  buildPluginLoaderAliasMap: _sdkAliasDiiCKlea.t,
  listPluginSdkAliasCandidates: _sdkAliasDiiCKlea.a,
  listPluginSdkExportedSubpaths: _sdkAliasDiiCKlea.o,
  resolveExtensionApiAlias: _sdkAliasDiiCKlea.c,
  resolvePluginSdkScopedAliasMap: _sdkAliasDiiCKlea.h,
  resolvePluginSdkAliasCandidateOrder: _sdkAliasDiiCKlea.p,
  resolvePluginSdkAliasFile: _sdkAliasDiiCKlea.m,
  resolvePluginRuntimeModulePath: _sdkAliasDiiCKlea.f,
  ensureOpenClawPluginSdkAlias,
  shouldLoadChannelPluginInSetupRuntime: _loaderChannelSetupCHB0cfUp.o,
  shouldPreferNativeModuleLoad: _sdkAliasDiiCKlea.g,
  toSafeImportPath: _pluginModuleLoaderCacheB600Kx.s,
...
function readPackageVersionForCache(packageJsonPath) {
  try {
    const parsed = JSON.parse(_nodeFs.default.readFileSync(packageJsonPath, "utf8"));
...
function buildCacheKey(params) {
  const discoveryContext = (0, _pluginMetadataSnapshotMEvRUosy.o)({
    workspaceDir: params.workspaceDir,
  ...
  const installs = Object.fromEntries(Object.entries(params.installs ?? {}).map(([pluginId, install]) => [pluginId, {
    ...install,
    installPath: typeof install.installPath === "string" ? (0, _utilsD5swhEXt.p)(install.installPath, params.env) : install.installPath,
    sourcePath: typeof install.sourcePath === "string" ? (0, _utilsD5swhEXt.p)(install.sourcePath, params.env) : install.sourcePath
  }]));
  const scopeKey = (0, _packageStateProbesAnoN2cCB.s)(params.onlyPluginIds);
  ...
  return `${roots.workspace ?? ""}::${roots.global ?? ""}::${roots.stock ?? ""}::${JSON.stringify({
    bundledPackage,
    discoveryFingerprint: (0, _pluginMetadataSnapshotMEvRUosy.i)(discoveryContext),
    ...params.plugins,
    installs,
    loadPaths,
...
function resolvePluginRegistrationPlan(params) {
  ...
  if (params.shouldLoadModules && !params.validateOnly && (0, _loaderChannelSetupCHB0cfUp.o)({
...
function resolvePluginLoadCacheContext(options = {}) {
  ...
  const cfg = (0, _configStateWKtsQXM.t)(options.config ?? {}, env);
  const activationSourceConfig = resolvePluginActivationSourceConfig({
    config: options.config,
    activationSourceConfig: options.activationSourceConfig
  });
  const normalized = (0, _configStateWKtsQXM.s)(cfg.plugins);
  const activationSource = (0, _configStateWKtsQXM.n)({ config: activationSourceConfig });
  const trustNormalized = mergeTrustPluginConfigFromActivationSource({
    normalized,
    activationSource
  });
  const onlyPluginIds = (0, _packageStateProbesAnoN2cCB.o)(options.onlyPluginIds);
  ...
  const installRecords = {
    ...(0, _manifestRegistryBiAsJcRZ.s)({ env }),
...
function getCompatibleActivePluginRegistry(options = {}) {
  const activeRegistry = (0, _runtimeB0MMVyKh.a)() ?? void 0;
  if (!activeRegistry) return;
  if (!hasExplicitCompatibilityInputs(options)) return activeRegistry;
  const activeCacheKey = (0, _runtimeB0MMVyKh.o)();
  ...
  if (loadContext.runtimeSubagentMode === "default" && (0, _runtimeB0MMVyKh.l)() === "gateway-bindable") {
...
function resolvePluginModuleExport(moduleExport) {
  ...
  const candidates = [(0, _moduleExportD8gdH2Hj.t)(moduleExport), moduleExport];
...
function activatePluginRegistry(registry, cacheKey, runtimeSubagentMode, workspaceDir) {
  const preserveGatewayHookRunner = runtimeSubagentMode === "default" && (0, _runtimeB0MMVyKh.l)() === "gateway-bindable" && (0, _hookRunnerGlobalCCAcWVdN.t)() !== null;
  (0, _runtimeB0MMVyKh.x)(registry, cacheKey, runtimeSubagentMode, workspaceDir);
  if (!preserveGatewayHookRunner) (0, _hookRunnerGlobalCCAcWVdN.i)(registry);
}
function loadOpenClawPlugins(options = {}) {
  const requestedOnlyPluginIdSet = (0, _packageStateProbesAnoN2cCB.r)((0, _packageStateProbesAnoN2cCB.o)(options.onlyPluginIds));
  if (requestedOnlyPluginIdSet && requestedOnlyPluginIdSet.size === 0) {
    const emptyRegistry = (0, _runtimeB0MMVyKh.P)();
  ...
  const onlyPluginIdSet = (0, _packageStateProbesAnoN2cCB.r)(onlyPluginIds);
  ...
  if (cacheEnabled) {
    ...
    if (cached) {
      if (shouldActivate) {
        ...
        (0, _typesCdFhLeaX.j)(cached.state.commands ?? []);
        restoreRegisteredCompactionProviders(cached.state.compactionProviders);
        (0, _detachedTaskRuntimeStateDyzZsL3h.a)(cached.state.detachedTaskRuntimeRegistration);
        (0, _typesCdFhLeaX.x)(cached.state.interactiveHandlers ?? []);
        (0, _memoryEmbeddingProviders3vy8Xe8H.s)(cached.state.memoryEmbeddingProviders);
        (0, _memoryStateDKt50i_K.S)({
  ...
  try {
    ...
    const resolveCreatePluginRuntime = () => {
      ...
      const runtimeModulePath = (0, _sdkAliasDiiCKlea.f)({ pluginSdkResolution: options.pluginSdkResolution });
      if (!runtimeModulePath) throw new Error("Unable to resolve plugin runtime module");
      const runtimeModule = (0, _pluginLoadProfileCX9TjsiD.i)({ source: runtimeModulePath }, "runtime-module", () => loadPluginModule(runtimeModulePath));
    ...
    const discovery = suppliedManifestRegistry ? {
      ...
      diagnostics: []
    } : (0, _discoveryCVL9KJt.t)({
      workspaceDir: options.workspaceDir,
      extraPaths: normalized.loadPaths,
      env,
      installRecords
    });
    const manifestRegistry = suppliedManifestRegistry ?? (0, _manifestRegistryBiAsJcRZ.t)({
      config: cfg,
      workspaceDir: options.workspaceDir,
      env,
    ...
    for (const candidate of orderedCandidates) {
      ...
      const activationState = (0, _configStateWKtsQXM.l)({
        id: pluginId,
        origin: candidate.origin,
        config: normalized,
        rootConfig: cfg,
        enabledByDefault: (0, _installedPluginIndexStoreDH9sPamj.g)(manifestRecord),
        activationSource,
      ...
      if (existingOrigin) {
        const record = createPluginRecord({
          ...
          enabled: false,
          compat: (0, _installedPluginIndexStoreDH9sPamj.p)(manifestRecord),
          activationState,
      ...
      const enableState = (0, _configStateWKtsQXM.c)({
        id: pluginId,
        origin: candidate.origin,
        config: normalized,
        rootConfig: cfg,
      ...
      if (record.format === "bundle") {
        ...
        if (enableState.enabled && record.rootDir && record.bundleFormat && (record.bundleCapabilities ?? []).includes("mcpServers")) {
          const runtimeSupport = (0, _bundleMcpDPPOalPH.n)({
            pluginId: record.id,
            rootDir: record.rootDir,
      ...
      if (registrationPlan.runRuntimeCapabilityPolicy && candidate.origin === "bundled" && (0, _slotsCQkAb1S.r)(manifestRecord.kind, "memory")) {
        if (pluginId !== dreamingEngineId) {
          const earlyMemoryDecision = (0, _configStateWKtsQXM.d)({
            id: record.id,
      ...
      if (!shouldLoadModules && registrationPlan.runRuntimeCapabilityPolicy) {
        const memoryDecision = (0, _configStateWKtsQXM.d)({
          id: record.id,
          kind: record.kind,
          slot: memorySlot,
          selectedId: selectedMemoryPluginId
        ...
        if (memoryDecision.selected && (0, _slotsCQkAb1S.r)(record.kind, "memory")) {
      ...
      if (registrationPlan.loadSetupEntry && manifestRecord.setupSource) {
        const setupRegistration = (0, _loaderChannelSetupCHB0cfUp.a)(mod);
        ...
        if (setupRegistration.plugin) {
          if (!(0, _loaderChannelSetupCHB0cfUp.t)({
          ...
          if (registrationPlan.loadSetupRuntimeEntry && setupRegistration.usesBundledSetupContract && resolveCanonicalDistRuntimeSource(runtimeCandidateEntry.source) !== safeSource) {
            const runtimeOpened = (0, _boundaryFileReadOFRaIDYB.i)({
            ...
            let runtimeMod = null;
            try {
              runtimeMod = (0, _pluginLoadProfileCX9TjsiD.i)({
                pluginId: record.id,
            ...
            const runtimeRegistration = (0, _loaderChannelSetupCHB0cfUp.i)(runtimeMod);
            ...
            const runtimePluginRegistration = (0, _loaderChannelSetupCHB0cfUp.n)({ registration: runtimeRegistration });
            ...
            if (runtimePluginRegistration.plugin) {
              ...
              mergedSetupRegistration = {
                ...setupRegistration,
                plugin: (0, _loaderChannelSetupCHB0cfUp.r)(runtimePluginRegistration.plugin, setupRegistration.plugin),
      ...
      if (manifestKind && exportKind && !(0, _slotsCQkAb1S.i)(manifestKind, exportKind)) registry.diagnostics.push({
        level: "warn",
        pluginId: record.id,
        source: record.source,
      ...
      if ((0, _slotsCQkAb1S.r)(record.kind, "memory") && memorySlot === record.id) memorySlotMatched = true;
      ...
      const previousDetachedTaskRuntimeRegistration = (0, _detachedTaskRuntimeStateDyzZsL3h.n)();
      const previousMemoryCapability = (0, _memoryStateDKt50i_K.i)();
      const previousMemoryEmbeddingProviders = (0, _memoryEmbeddingProviders3vy8Xe8H.a)();
      const previousMemoryCorpusSupplements = (0, _memoryStateDKt50i_K.u)();
      const previousMemoryPromptSupplements = (0, _memoryStateDKt50i_K.d)();
      try {
        (0, _pluginLoadProfileCX9TjsiD.i)({
          pluginId: record.id,
          source: record.source
        ...
        if (!shouldActivate) {
          ...
          (0, _detachedTaskRuntimeStateDyzZsL3h.a)(previousDetachedTaskRuntimeRegistration);
          (0, _memoryEmbeddingProviders3vy8Xe8H.s)(previousMemoryEmbeddingProviders);
          (0, _memoryStateDKt50i_K.S)({
    ...
    if (cacheEnabled) setCachedPluginRegistry(cacheKey, {
      commands: (0, _typesCdFhLeaX.k)(),
      detachedTaskRuntimeRegistration: (0, _detachedTaskRuntimeStateDyzZsL3h.n)(),
      interactiveHandlers: (0, _typesCdFhLeaX.v)(),
      memoryCapability: (0, _memoryStateDKt50i_K.i)(),
      memoryCorpusSupplements: (0, _memoryStateDKt50i_K.u)(),
      registry,
      agentHarnesses: listRegisteredAgentHarnesses(),
      compactionProviders: listRegisteredCompactionProviders(),
      memoryEmbeddingProviders: (0, _memoryEmbeddingProviders3vy8Xe8H.a)(),
      memoryPromptSupplements: (0, _memoryStateDKt50i_K.d)()
    }, onlyPluginIds);
...
async function loadOpenClawPluginCliRegistry(options = {}) {
  ...
  const discovery = (0, _discoveryCVL9KJt.t)({
    workspaceDir: options.workspaceDir,
    extraPaths: normalized.loadPaths,
    env,
    installRecords
  });
  const manifestRegistry = (0, _manifestRegistryBiAsJcRZ.t)({
    config: cfg,
    workspaceDir: options.workspaceDir,
    env,
    candidates: discovery.candidates,
  ...
  for (const candidate of orderedCandidates) {
    ...
    const api = (0, _apiBuilderNgUrqxn.t)({
      id: record.id,
      name: record.name,
      version: record.version,
      description: record.description,
      ...
      runtime: {},
      logger,
      resolvePath: (input) => (0, _utilsD5swhEXt.p)(input),
