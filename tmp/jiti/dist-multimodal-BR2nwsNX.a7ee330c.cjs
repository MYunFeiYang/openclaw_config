"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = isMemoryMultimodalEnabled;exports.i = getMemoryMultimodalExtensions;exports.n = buildMemoryMultimodalLabel;exports.o = normalizeMemoryMultimodalSettings;exports.r = classifyMemoryMultimodalPath;exports.t = buildCaseInsensitiveExtensionGlob;var _stringUtilsDoQjWCc = require("./string-utils-DoQjWCc3.js");
...
function buildCaseInsensitiveExtensionGlob(extension) {
  const normalized = (0, _stringUtilsDoQjWCc.t)(extension).replace(/^\./, "");
...
function classifyMemoryMultimodalPath(filePath, settings) {
  ...
  const lower = (0, _stringUtilsDoQjWCc.t)(filePath);
