"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = fetchWithRuntimeDispatcherOrMockedGlobal;exports.r = isMockedFetch;exports.t = fetchWithRuntimeDispatcher;var _fetchHeadersCGp03wKO = require("./fetch-headers-CGp03wKO.js");
...
function normalizeRuntimeRequestInit(init, RuntimeFormData) {
  if (!init) return init;
  const normalizedHeaders = (0, _fetchHeadersCGp03wKO.t)(init.headers);
...
async function fetchWithRuntimeDispatcher(input, init) {
  const runtimeDeps = (0, _undiciRuntimeDDjv6AiC.i)();
