"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveBinaryVersion;exports.c = resolveUsableRuntimeVersion;exports.i = readVersionFromPackageJsonForModuleUrl;exports.l = resolveVersionFromModuleUrl;exports.n = void 0;exports.o = resolveCompatibilityHostVersion;exports.r = readVersionFromBuildInfoForModuleUrl;exports.s = resolveRuntimeServiceVersion;exports.t = void 0;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
...
function readVersionFromJsonCandidates(moduleUrl, candidates, opts = {}) {
  try {
    ...
    for (const candidate of candidates) try {
      ...
      const version = (0, _stringCoerceBje8XVt.c)(parsed.version);
      if (!version) continue;
...
function resolveUsableRuntimeVersion(version) {
  const trimmed = (0, _stringCoerceBje8XVt.c)(version);
...
const VERSION = exports.n = resolveBinaryVersion({
  moduleUrl: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/version-DdTF4eka.js",
  injectedVersion: typeof __OPENCLAW_VERSION__ === "string" ? __OPENCLAW_VERSION__ : void 0,
  bundledVersion: process.env.OPENCLAW_BUNDLED_VERSION
});
//#endregion /* v9-4ab4834ad99cc690 */
