...
var _restartStalePidsBbzkwx_P = require("./restart-stale-pids-Bbzkwx_P.js");
...
function readGatewayProcessArgsSync(pid) {
  ...
  if (process.platform === "win32") return (0, _restartStalePidsBbzkwx_P.a)(pid);
  return null;
}
...
function findVerifiedGatewayListenerPidsOnPortSync(port) {
  const rawPids = process.platform === "win32" ? (0, _restartStalePidsBbzkwx_P.i)(port) : (0, _restartStalePidsBbzkwx_P.n)(port);
