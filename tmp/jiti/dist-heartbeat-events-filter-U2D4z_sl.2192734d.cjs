"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = isExecCompletionEvent;exports.n = buildExecEventPrompt;exports.r = isCronSystemEvent;exports.t = buildCronEventPrompt;var _stringCoerceBje8XVt = require("./string-coerce-Bje8XVt9.js");
...
const HEARTBEAT_OK_PREFIX = (0, _stringCoerceBje8XVt.a)(_tokensBIJuzXU.t);
...
function isHeartbeatNoiseEvent(evt) {
  const lower = (0, _stringCoerceBje8XVt.a)(evt);
...
function isExecCompletionEvent(evt) {
  const normalized = (0, _stringCoerceBje8XVt.a)(evt).trimStart();
