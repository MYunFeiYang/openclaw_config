...
function resolvePackageRootsForBundledPlugins() {
  return [(0, _openclawRootCRSCIPqz.n)({ argv1: process.argv[1] }), (0, _openclawRootCRSCIPqz.n)({ moduleUrl: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-dir-DL2yDGTU.js" })].filter((entry, index, all) => Boolean(entry) && all.indexOf(entry) === index);
}
...
function resolveTrustedExistingOverride(resolvedOverride) {
  ...
  const modulePackageRoot = (0, _openclawRootCRSCIPqz.n)({ moduleUrl: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-dir-DL2yDGTU.js" });
...
function resolveBundledPluginsDirUncached(env) {
  ...
  try {
    ...
    })) ? null : argvRoot, (0, _openclawRootCRSCIPqz.n)({ moduleUrl: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-dir-DL2yDGTU.js" })].filter((entry, index, all) => Boolean(entry) && all.indexOf(entry) === index);
  ...
  try {
    let cursor = _nodePath.default.dirname((0, _nodeUrl.fileURLToPath)("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-dir-DL2yDGTU.js"));
    for (let i = 0; i < 6; i += 1) {
