...
var _globalsBmUmhyAe = require("./globals-BmUmhyAe.js");
var _windowsCommandDJ7ha6z = require("./windows-command-DJ7ha6z1.js");
var _loggerBGaqbYrv = require("./logger-BGaqbYrv.js");
...
async function runExec(command, args, opts = 1e4) {
  ...
  try {
    ...
    if ((0, _globalsBmUmhyAe.a)()) {
      if (decodedStdout.trim()) (0, _loggerBGaqbYrv.t)(decodedStdout.trim());
      if (decodedStderr.trim()) (0, _loggerBGaqbYrv.n)(decodedStderr.trim());
    }
    return {
    ...
    if ((0, _globalsBmUmhyAe.a)()) (0, _loggerBGaqbYrv.n)((0, _globalsBmUmhyAe.t)(`Command failed: ${command} ${args.join(" ")}`));
    throw err;
  }
}
