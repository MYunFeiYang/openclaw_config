"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = shouldUseSyntheticOllamaAuth;exports.n = void 0;exports.r = resolveOllamaDiscoveryResult;exports.t = void 0;var _defaultsCzZ4gaZT = require("./defaults-CzZ4gaZT.js");
var _providerBaseUrlJLUYgUyq = require("./provider-base-url-JLUYgUyq.js");
...
function hasExplicitRemoteOllamaApiProvider(providers) {
  ...
  for (const [providerId, provider] of Object.entries(providers)) {
    ...
    const baseUrl = (0, _providerBaseUrlJLUYgUyq.t)(provider);
...
function shouldUseSyntheticOllamaAuth(providerConfig) {
  ...
  return isLocalOllamaBaseUrl((0, _providerBaseUrlJLUYgUyq.t)(providerConfig));
}
function hasMeaningfulExplicitOllamaConfig(providerConfig) {
  ...
  const baseUrl = (0, _providerBaseUrlJLUYgUyq.t)(providerConfig);
  if (baseUrl) return (0, _providerBaseUrlJLUYgUyq.u)(baseUrl) !== _defaultsCzZ4gaZT.n;
...
async function resolveOllamaDiscoveryResult(params) {
  ...
  if (hasExplicitModels && explicit) {
    const baseUrl = (0, _providerBaseUrlJLUYgUyq.u)((0, _providerBaseUrlJLUYgUyq.t)(explicit) ?? "http://127.0.0.1:11434");
  ...
  const configuredBaseUrl = (0, _providerBaseUrlJLUYgUyq.t)(explicit);
