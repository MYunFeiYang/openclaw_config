...
var _publicSurfaceLoaderCmB9RRj = require("./public-surface-loader-Cm-b9RRj.js");
...
function tryLoadBundledProviderPolicySurface(pluginId) {
  for (const artifactBasename of PROVIDER_POLICY_ARTIFACT_CANDIDATES) try {
    const mod = (0, _publicSurfaceLoaderCmB9RRj.t)({
      dirName: pluginId,
      artifactBasename
    });
...
function resolveBundledProviderPolicyPluginId(providerId, options = {}) {
  ...
  const registry = options.manifestRegistry ?? (0, _manifestRegistryCFqIGq5y.t)();
