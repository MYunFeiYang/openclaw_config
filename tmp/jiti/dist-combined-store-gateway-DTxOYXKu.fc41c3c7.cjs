...
function resolveDefaultStoreAgentId(cfg) {
  return (0, _sessionKeyCQewiu8n.c)((0, _agentScopeConfigDUwbsKjv.c)(cfg));
}
function shouldRemapLegacyDefaultMainAlias(cfg, parsed, options) {
  if ((0, _sessionKeyCQewiu8n.c)(parsed.agentId) !== "main" || (0, _agentScopeConfigDUwbsKjv.n)(cfg).includes("main")) return false;
...
function loadCombinedSessionStoreForGateway(cfg, opts = {}) {
  ...
  if (storeConfig && !isStorePathTemplate(storeConfig)) {
    ...
    const defaultAgentId = (0, _sessionKeyCQewiu8n.c)((0, _agentScopeConfigDUwbsKjv.c)(cfg));
    const store = (0, _storeLoadDjaY7SAt.t)(storePath, { clone: false });
    const combined = {};
  ...
  const targets = requestedAgentId ? (0, _targetsDGxp4nvt.n)(cfg, requestedAgentId) : opts.configuredAgentsOnly === true ? (0, _targetsDGxp4nvt.a)(cfg, { allAgents: true }) : (0, _targetsDGxp4nvt.i)(cfg);
  const combined = {};
