"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = forceResetGlobalDispatcher;exports.i = ensureGlobalUndiciStreamTimeouts;exports.n = void 0;exports.o = resetGlobalUndiciStreamTimeoutsForTests;exports.r = ensureGlobalUndiciEnvProxyDispatcher;exports.t = void 0;var _proxyEnvBnCLNOp = require("./proxy-env-BnC-lNOp.js");
var _undiciFamilyPolicyBAzZfcab = require("./undici-family-policy-BAzZfcab.js");
...
function ensureGlobalUndiciEnvProxyDispatcher() {
  if (!(0, _proxyEnvBnCLNOp.n)()) return;
  ...
  try {
    (0, _undici.setGlobalDispatcher)(new _undici.EnvHttpProxyAgent((0, _proxyEnvBnCLNOp.o)()));
    lastAppliedProxyBootstrap = true;
  } catch {}
}
function ensureGlobalUndiciStreamTimeouts(opts) {
  ...
  if (kind === null) return;
  const autoSelectFamily = (0, _undiciFamilyPolicyBAzZfcab.n)();
  ...
  const connect = (0, _undiciFamilyPolicyBAzZfcab.t)(autoSelectFamily);
  try {
    if (kind === "env-proxy") (0, _undici.setGlobalDispatcher)(new _undici.EnvHttpProxyAgent({
      ...(0, _proxyEnvBnCLNOp.o)(),
...
function forceResetGlobalDispatcher() {
  ...
  lastAppliedProxyBootstrap = false;
  try {
    const proxyOptions = (0, _proxyEnvBnCLNOp.o)();
    if ((0, _proxyEnvBnCLNOp.n)()) {
