...
var _configSchemaD9xBKsCU = require("./config-schema-D9xBKsCU.js");
...
function resolveConfigSchemaExport(imported) {
  ...
  for (const [name, value] of Object.entries(imported)) {
    ...
    if (isJsonSchemaConfigSurface(value)) return (0, _configSchemaD9xBKsCU.i)(value);
    if (value && typeof value === "object") return (0, _configSchemaD9xBKsCU.r)(value);
  }
...
function getModuleLoader(modulePath) {
  return (0, _pluginModuleLoaderCacheAuBzBauz.n)({
    cache: moduleLoaders,
    modulePath,
    importerUrl: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-plugin-metadata-AWw5TsmM.js",
    preferBuiltDist: true,
    loaderFilename: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-plugin-metadata-AWw5TsmM.js"
  });
}
...
const OPENCLAW_PACKAGE_ROOT = (0, _sdkAliasBOEr.l)({
  modulePath: (0, _nodeUrl.fileURLToPath)("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-plugin-metadata-AWw5TsmM.js"),
  moduleUrl: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-plugin-metadata-AWw5TsmM.js"
}) ?? (0, _nodeUrl.fileURLToPath)(new URL("../..", "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-plugin-metadata-AWw5TsmM.js"));
const CURRENT_MODULE_PATH = (0, _nodeUrl.fileURLToPath)("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/bundled-plugin-metadata-AWw5TsmM.js");
