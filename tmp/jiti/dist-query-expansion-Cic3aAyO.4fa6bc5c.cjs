"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = isQueryStopWordToken;exports.t = extractKeywords;var _stringUtilsDoQjWCc = require("./string-utils-DoQjWCc3.js");
...
function tokenize(text, opts) {
  ...
  const tokens = [];
  const segments = (0, _stringUtilsDoQjWCc.t)(text).split(/[\s\p{P}]+/u).filter(Boolean);
