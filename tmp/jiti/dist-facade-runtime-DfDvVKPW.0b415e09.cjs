...
var _facadeLoaderCKrcnWNf = require("./facade-loader-CKrcnWNf.js");
...
const OPENCLAW_PACKAGE_ROOT = (0, _sdkAliasBOEr.l)({
  modulePath: (0, _nodeUrl.fileURLToPath)("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/facade-runtime-DfDvVKPW.js"),
  moduleUrl: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/facade-runtime-DfDvVKPW.js"
}) ?? (0, _nodeUrl.fileURLToPath)(new URL("../..", "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/facade-runtime-DfDvVKPW.js"));
const CURRENT_MODULE_PATH = (0, _nodeUrl.fileURLToPath)("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/facade-runtime-DfDvVKPW.js");
...
const nodeRequire = (0, _nodeModule.createRequire)("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/facade-runtime-DfDvVKPW.js");
...
function getFacadeActivationCheckRuntimeSourceLoader(modulePath) {
  return (0, _pluginModuleLoaderCacheAuBzBauz.r)({
    cache: facadeActivationCheckRuntimeLoaders,
    modulePath,
    importerUrl: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/facade-runtime-DfDvVKPW.js",
    loaderFilename: "file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/facade-runtime-DfDvVKPW.js",
    aliasMap: {}
  });
}
...
function loadFacadeModuleAtLocationSync(params) {
  return (0, _facadeLoaderCKrcnWNf.i)(params);
}
...
function loadBundledPluginPublicSurfaceModuleSync(params) {
  ...
  if (!location) return (0, _facadeLoaderCKrcnWNf.r)({
    ...params,
    trackedPluginId
  });
