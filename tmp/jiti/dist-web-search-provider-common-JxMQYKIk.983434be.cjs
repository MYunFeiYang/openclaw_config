...
var _webSharedB5rPf4r = require("./web-shared-B5rPf4r6.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
//#region src/agents/tools/web-search-provider-common.ts
const webGuardedFetchLoader = (0, _lazyPromiseSFT4i6yI.t)(() => Promise.resolve().then(() => jitiImport("./web-guarded-fetch-BZAOsq1M.js").then((m) => _interopRequireWildcard(m))));
...
function resolveSearchTimeoutSeconds(searchConfig) {
  return (0, _webSharedB5rPf4r.s)(searchConfig?.timeoutSeconds, 30);
}
function resolveSearchCacheTtlMs(searchConfig) {
  return (0, _webSharedB5rPf4r.o)(searchConfig?.cacheTtlMinutes, 15);
}
...
async function postTrustedWebToolsJson(params, parseResponse) {
  return (await loadTrustedWebToolsEndpoint())({
    ...
    if (!response.ok) {
      const detail = await (0, _webSharedB5rPf4r.a)(response, { maxBytes: params.maxErrorBytes ?? 64e3 });
...
async function throwWebSearchApiError(res, providerLabel) {
  const detail = (await (0, _webSharedB5rPf4r.a)(res, { maxBytes: 64e3 })).text;
...
function readCachedSearchPayload(cacheKey) {
  const cached = (0, _webSharedB5rPf4r.i)(SEARCH_CACHE, cacheKey);
  return cached ? {
    ...cached.value,
    cached: true
  } : void 0;
...
function buildSearchCacheKey(parts) {
  return (0, _webSharedB5rPf4r.r)(parts.map((part) => part === void 0 ? "default" : String(part)).join(":"));
}
function writeCachedSearchPayload(cacheKey, payload, ttlMs) {
  (0, _webSharedB5rPf4r.l)(SEARCH_CACHE, cacheKey, payload, ttlMs);
}
