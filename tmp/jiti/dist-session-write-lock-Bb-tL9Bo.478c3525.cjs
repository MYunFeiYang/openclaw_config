"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = acquireSessionWriteLock;exports.c = resetSessionWriteLockStateForTest;exports.d = resolveSessionWriteLockMaxHoldMs;exports.f = resolveSessionWriteLockOptions;exports.i = void 0;exports.l = resolveSessionLockMaxHoldFromTimeout;exports.n = void 0;exports.o = cleanStaleLockFiles;exports.p = resolveSessionWriteLockStaleMs;exports.r = void 0;exports.s = drainSessionWriteLockStateForTest;exports.t = void 0;exports.u = resolveSessionWriteLockAcquireTimeoutMs;require("./fs-safe-defaults-azXCfv92.js");
var _fileLockBmUfoFn = require("./file-lock-BmUfoFn1.js");
var _pidAliveB3tYqreQ = require("./pid-alive-B3tYqreQ.js");
var _gatewayProcessesMEZMoQs = require("./gateway-processes-MEZMoQs5.js");
...
async function removeReportedStaleLockIfStillStale(params) {
  ...
  const inspected = inspectLockPayloadForSession({
    ...
    readOwnerProcessArgs: params.readOwnerProcessArgs ?? _gatewayProcessesMEZMoQs.r
  });
...
async function cleanStaleLockFiles(params) {
  ...
  const ownerProcessArgsReader = params.readOwnerProcessArgs ?? _gatewayProcessesMEZMoQs.r;
  let entries = [];
  try {
    ...
    return { release: (await SESSION_LOCKS.acquire(sessionFile, {
        ...
        shouldReclaim: async ({ payload, nowMs, heldByThisProcess }) => {
          return await shouldReclaimContendedLockFile(lockPath, inspectLockPayloadForSession({
            ...
            heldByThisProcess,
            reclaimLockWithoutStarttime: true,
            readOwnerProcessArgs: _gatewayProcessesMEZMoQs.r
          }), staleMs, nowMs);
        }
      })).release };
  } catch (err) {
