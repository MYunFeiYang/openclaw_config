"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = isJavaScriptModulePath;exports.i = getPluginModuleLoaderStats;exports.n = getCachedPluginModuleLoader;exports.o = tryNativeRequireJavaScriptModule;exports.r = getCachedPluginSourceModuleLoader;exports.s = toSafeImportPath;exports.t = createPluginModuleLoaderCache;var _pluginCachePrimitivesWfwcOrBF = require("./plugin-cache-primitives-WfwcOrBF.js");
...
const nodeRequire = (0, _nodeModule.createRequire)("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/plugin-module-loader-cache-B60-0Kx3.js");
...
const requireForJiti = (0, _nodeModule.createRequire)("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/plugin-module-loader-cache-B60-0Kx3.js");
...
function createPluginModuleLoaderCache(maxEntries = DEFAULT_PLUGIN_MODULE_LOADER_CACHE_ENTRIES) {
  return new _pluginCachePrimitivesWfwcOrBF.t(maxEntries);
}
function resolveDefaultPluginModuleLoaderConfig(params) {
  return (0, _sdkAliasDiiCKlea.u)({
...
function resolvePluginModuleLoaderCacheEntry(params) {
  ...
  const cacheKey = resolved.cacheKey ?? (0, _sdkAliasDiiCKlea.r)({
    tryNative,
    aliasMap
  });
  return {
...
function createLazySourceTransformLoader(params) {
  ...
  return () => {
    ...
    const jitiLoader = (params.createLoader ?? loadCreateJitiLoaderFactory())(params.loaderFilename, {
      ...(0, _sdkAliasDiiCKlea.n)(params.aliasMap),
