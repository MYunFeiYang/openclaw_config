"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.DEFAULT_ACCOUNT_ID = void 0;exports.addWildcardAllowFrom = addWildcardAllowFrom;exports.buildAccountScopedDmSecurityPolicy = buildAccountScopedDmSecurityPolicy;exports.buildAccountScopedDmSecurityPolicyCompat = buildAccountScopedDmSecurityPolicyCompat;exports.detectMime = detectMime;exports.emptyPluginConfigSchema = emptyPluginConfigSchema;exports.formatPairingApproveHint = formatPairingApproveHint;exports.getDefaultMediaLocalRoots = getDefaultMediaLocalRoots;exports.loadOutboundMediaFromUrl = loadOutboundMediaFromUrl;exports.parseOptionalDelimitedEntries = parseOptionalDelimitedEntries;Object.defineProperty(exports, "resolveStateDir", { enumerable: true, get: function () {return _stateDirResolve.resolveStateDir;} });
...
var _stateDirResolve = require("./state-dir-resolve.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);} /**
 ...
 */const DEFAULT_ACCOUNT_ID = exports.DEFAULT_ACCOUNT_ID = "default";const _sdkReady = Promise.resolve().then(() => jitiImport("openclaw/plugin-sdk/core").then((m) => _interopRequireWildcard(m))).then((sdk) => {const exports = {};if (typeof sdk.loadOutboundMediaFromUrl === "function") {exports.loadOutboundMediaFromUrl = sdk.loadOutboundMediaFromUrl;}
...
const _setupSdkReady = Promise.resolve().then(() => jitiImport("openclaw/plugin-sdk/setup").then((m) => _interopRequireWildcard(m))).
then((sdk) => {
  if (typeof sdk.addWildcardAllowFrom === "function") {
...
async function sniffMimeFromBuffer(buffer) {
  try {
    const { fileTypeFromBuffer } = await Promise.resolve().then(() => jitiImport("file-type").then((m) => _interopRequireWildcard(m)));
...
async function getDefaultMediaLocalRoots() {
  ...
  // fallback: 手动构建默认白名单
  const stateDir = path.resolve((0, _stateDirResolve.resolveStateDir)());
  return [
...
const _sdkPolicyReady = (async () => {
  try {
    // 尝试从主 SDK 包导入
    const sdk = await Promise.resolve().then(() => jitiImport("openclaw/plugin-sdk/channel-policy").then((m) => _interopRequireWildcard(m)));
 ...
 * 不可用时使用 fallback 实现。
 */
async function buildAccountScopedDmSecurityPolicyCompat(params) {
