"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = loadUndiciRuntimeDeps;exports.n = createHttp1EnvHttpProxyAgent;exports.r = createHttp1ProxyAgent;exports.t = createHttp1Agent;var _undiciFamilyPolicyBAzZfcab = require("./undici-family-policy-BAzZfcab.js");
...
function loadUndiciRuntimeDeps() {
  ...
  const undici = (0, _nodeModule.createRequire)("file:///Users/thinkway/.nvm/versions/node/v24.14.0/lib/node_modules/openclaw/dist/undici-runtime-DDjv6AiC.js")("undici");
  return {
    Agent: undici.Agent,
...
function withHttp1OnlyDispatcherOptions(options, timeoutMs, applyTo) {
  ...
  const autoSelectConnect = (0, _undiciFamilyPolicyBAzZfcab.r)();
