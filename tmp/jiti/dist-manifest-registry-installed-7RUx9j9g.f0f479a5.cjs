...
function resolveInstalledManifestRegistryIndexFingerprint(index) {
  return (0, _installedPluginIndexStoreIOgCdyHd.b)(buildInstalledManifestRegistryIndexKey(index));
}
...
function loadPluginManifestRegistryForInstalledIndex(params) {
  return (0, _discoveryBNk7kgJV.o)("manifest registry", () => {
    ...
    return (0, _manifestRegistryCFqIGq5y.t)({
      config: params.config,
      workspaceDir: params.workspaceDir,
      env,
      candidates,
      diagnostics: [...diagnostics],
      installRecords: (0, _installedPluginIndexStoreIOgCdyHd.h)(params.index),
