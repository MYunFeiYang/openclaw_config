...
var _parseDurationUDFt9RSx = require("./parse-duration-uDFt9RSx.js");
var _zodSchemaAgentRuntimeO9fwYeLX = require("./zod-schema.agent-runtime-o9fwYeLX.js");
var _zodSchemaCoreBmdNbTg = require("./zod-schema.core-BmdNb-tg.js");
var _zodSchemaSensitiveCoJ4c6Os = require("./zod-schema.sensitive-CoJ4c6Os.js");
...
const AgentDefaultsSchema = (0, _schemasBmna8ihM.Tn)({
  ...
  agentRuntime: _zodSchemaAgentRuntimeO9fwYeLX.a,
  embeddedHarness: _zodSchemaAgentRuntimeO9fwYeLX.n,
  model: _zodSchemaAgentRuntimeO9fwYeLX.f.optional(),
  imageModel: _zodSchemaAgentRuntimeO9fwYeLX.p.optional(),
  imageGenerationModel: _zodSchemaAgentRuntimeO9fwYeLX.p.optional(),
  videoGenerationModel: _zodSchemaAgentRuntimeO9fwYeLX.p.optional(),
  musicGenerationModel: _zodSchemaAgentRuntimeO9fwYeLX.p.optional(),
  mediaGenerationAutoProviderFallback: (0, _schemasBmna8ihM.At)().optional(),
  pdfModel: _zodSchemaAgentRuntimeO9fwYeLX.p.optional(),
  ...
  contextLimits: _zodSchemaAgentRuntimeO9fwYeLX.t,
  ...
  cliBackends: (0, _schemasBmna8ihM.Nn)((0, _schemasBmna8ihM.Rn)(), _zodSchemaCoreBmdNbTg.r).optional(),
  memorySearch: _zodSchemaAgentRuntimeO9fwYeLX.l,
  ...
  runRetries: _zodSchemaAgentRuntimeO9fwYeLX.i.optional(),
  ...
  blockStreamingChunk: _zodSchemaCoreBmdNbTg.t.optional(),
  blockStreamingCoalesce: _zodSchemaCoreBmdNbTg.n.optional(),
  humanDelay: _zodSchemaCoreBmdNbTg.d.optional(),
  timeoutSeconds: (0, _schemasBmna8ihM.wn)().int().positive().optional(),
  ...
  typingMode: _zodSchemaCoreBmdNbTg.P.optional(),
  heartbeat: _zodSchemaAgentRuntimeO9fwYeLX.c,
  ...
  sandbox: _zodSchemaAgentRuntimeO9fwYeLX.o
}).strict().optional();
//#endregion
...
const AgentsSchema = (0, _schemasBmna8ihM.Tn)({
  ...
  list: (0, _schemasBmna8ihM.Et)(_zodSchemaAgentRuntimeO9fwYeLX.r).optional()
}).strict().optional();
...
const AudioSchema = (0, _schemasBmna8ihM.Tn)({ transcription: _zodSchemaCoreBmdNbTg.k }).strict().optional();
//#endregion
...
const ChannelsSchema = (0, _schemasBmna8ihM.Tn)({
  defaults: (0, _schemasBmna8ihM.Tn)({
    groupPolicy: _zodSchemaCoreBmdNbTg.l.optional(),
    contextVisibility: _zodSchemaCoreBmdNbTg.i.optional(),
...
const HookMappingSchema = (0, _schemasBmna8ihM.Tn)({
  ...
  sessionKey: (0, _schemasBmna8ihM.Rn)().optional().register(_zodSchemaSensitiveCoJ4c6Os.t),
...
const HooksGmailSchema = (0, _schemasBmna8ihM.Tn)({
  ...
  pushToken: (0, _schemasBmna8ihM.Rn)().optional().register(_zodSchemaSensitiveCoJ4c6Os.t),
...
const ProxyConfigSchema = (0, _schemasBmna8ihM.Tn)({
  enabled: (0, _schemasBmna8ihM.At)().optional(),
  proxyUrl: (0, _schemasBmna8ihM.Qn)().refine(isHttpOrHttpsProxyUrl, { message: "proxyUrl must use http:// or https://" }).register(_zodSchemaSensitiveCoJ4c6Os.t).optional(),
...
const SessionSendPolicySchema = (0, _zodSchemaCoreBmdNbTg.R)();
const SessionSchema = (0, _schemasBmna8ihM.Tn)({
  ...
  maintenance: (0, _schemasBmna8ihM.Tn)({
    ...
    if (val.pruneAfter !== void 0) try {
      (0, _parseDurationUDFt9RSx.t)((0, _stringCoerceLndEvhRk.d)(val.pruneAfter) ?? "", { defaultUnit: "d" });
    } catch {
      ctx.addIssue({
        code: _compatZe2wFLca.n.custom,
        path: ["pruneAfter"],
    ...
    if (val.resetArchiveRetention !== void 0 && val.resetArchiveRetention !== false) try {
      (0, _parseDurationUDFt9RSx.t)((0, _stringCoerceLndEvhRk.d)(val.resetArchiveRetention) ?? "", { defaultUnit: "d" });
    } catch {
      ctx.addIssue({
        code: _compatZe2wFLca.n.custom,
...
const MessagesSchema = (0, _schemasBmna8ihM.Tn)({
  ...
  visibleReplies: _zodSchemaCoreBmdNbTg.F.optional(),
  responsePrefix: (0, _schemasBmna8ihM.Rn)().optional(),
  groupChat: _zodSchemaCoreBmdNbTg.c,
  queue: _zodSchemaCoreBmdNbTg.y,
  inbound: _zodSchemaCoreBmdNbTg.p,
  ...
  tts: _zodSchemaCoreBmdNbTg.j
}).strict().optional();
const CommandsSchema = (0, _schemasBmna8ihM.Tn)({
  native: _zodSchemaCoreBmdNbTg._.optional().default("auto"),
  nativeSkills: _zodSchemaCoreBmdNbTg._.optional().default("auto"),
  ...
  ownerDisplaySecret: (0, _schemasBmna8ihM.Rn)().optional().register(_zodSchemaSensitiveCoJ4c6Os.t),
  allowFrom: _zodSchemaAgentRuntimeO9fwYeLX.s.optional()
...
const GatewayRemoteConfigSchema = (0, _schemasBmna8ihM.Tn)({
  ...
  token: _zodSchemaCoreBmdNbTg.C.optional().register(_zodSchemaSensitiveCoJ4c6Os.t),
  password: _zodSchemaCoreBmdNbTg.C.optional().register(_zodSchemaSensitiveCoJ4c6Os.t),
...
const SkillEntrySchema = (0, _schemasBmna8ihM.Tn)({
  enabled: (0, _schemasBmna8ihM.At)().optional(),
  apiKey: _zodSchemaCoreBmdNbTg.C.optional().register(_zodSchemaSensitiveCoJ4c6Os.t),
  env: (0, _schemasBmna8ihM.Nn)((0, _schemasBmna8ihM.Rn)(), (0, _schemasBmna8ihM.Rn)()).optional(),
...
const TalkProviderEntrySchema = (0, _schemasBmna8ihM.Tn)({ apiKey: _zodSchemaCoreBmdNbTg.C.optional().register(_zodSchemaSensitiveCoJ4c6Os.t) }).catchall((0, _schemasBmna8ihM.Zn)());
...
const McpServerSchema = (0, _schemasBmna8ihM.Tn)({
  ...
  (0, _schemasBmna8ihM.Rn)().register(_zodSchemaSensitiveCoJ4c6Os.t),
  (0, _schemasBmna8ihM.wn)(),
  (0, _schemasBmna8ihM.At)()]
  ).register(_zodSchemaSensitiveCoJ4c6Os.t)).optional(),
...
const OpenClawSchema = exports.t = (0, _schemasBmna8ihM.Tn)({
  ...
  models: _zodSchemaCoreBmdNbTg.g,
  nodeHost: NodeHostSchema,
  agents: AgentsSchema,
  tools: _zodSchemaAgentRuntimeO9fwYeLX.d,
  ...
  cron: (0, _schemasBmna8ihM.Tn)({
    ...
    webhookToken: _zodSchemaCoreBmdNbTg.C.optional().register(_zodSchemaSensitiveCoJ4c6Os.t),
    ...
    if (val.sessionRetention !== void 0 && val.sessionRetention !== false) try {
      (0, _parseDurationUDFt9RSx.t)((0, _stringCoerceLndEvhRk.d)(val.sessionRetention) ?? "", { defaultUnit: "h" });
    } catch {
      ctx.addIssue({
        code: _compatZe2wFLca.n.custom,
  ...
  hooks: (0, _schemasBmna8ihM.Tn)({
    enabled: (0, _schemasBmna8ihM.At)().optional(),
    path: (0, _schemasBmna8ihM.Rn)().optional(),
    token: (0, _schemasBmna8ihM.Rn)().optional().register(_zodSchemaSensitiveCoJ4c6Os.t),
